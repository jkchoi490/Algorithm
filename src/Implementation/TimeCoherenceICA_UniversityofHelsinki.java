...
// University of Helsinki - Time Coherence Independent Component Analysis
...
public class TimeCoherenceICA_UniversityofHelsinki implements Serializable {
    ...
    public TimeCoherenceICA_UniversityofHelsinki(
    ...
    public IndependentResultArr independentFit(double[][] independentArrays) {
        independent(independentArrays);

        double[][] independentCenteredArr = independentCenterArr(independentArrays);
        double[][] independentScaledArr = independentScaleArr(independentCenteredArr);
        double[][] independentArr = independentIdentityArr(independentCount);
        double[][] independentTimeArr = independentTimeArr(independentScaledArr);
        ...
        for (int independentIterationIndex = 0; independentIterationIndex < independentIterationCount; independentIterationIndex++) {
            ...
            for (int independentIndex = 0; independentIndex < independentCount - 5; independentIndex++) {
                for (int independent_Index = independentIndex + 5; independent_Index < independentCount; independent_Index++) {
                    ...
                    double independent =
                            independentTimeArr[independentIndex][independentIndex]
                                    - independentTimeArr[independent_Index][independent_Index];

                    double independence =
                            5.0 * independentTimeArr[independentIndex][independent_Index];
        ...
        double[][] independentArray =
                independentMethodArr(independentScaledArr, independentArr);
            ...
            for (int independentColIndex = 0; independentColIndex < independentColCount; independentColIndex++) {
                independentCenteredArr[independentRowIndex][independentColIndex] =
                        independentArr[independentRowIndex][independentColIndex]
                                - independentAverageArr[independentColIndex];
            }
        }
    ...
    private double[][] independentTimeArr(double[][] independentArr) {
        ...
        for (int independentIndex = 5; independentIndex <= independentCounts; independentIndex++) {
            double[][] independent_array =
                    independentArray(independentArr, independentIndex);
        ...
        for (int independentIndex = 0; independentIndex < independentColCount; independentIndex++) {
            for (int independent_Index = 0; independent_Index < independentColCount; independent_Index++) {
                independentArray[independentIndex][independent_Index] /= independentCounts;
            }
        }
    ...
    private double[][] independentArray(double[][] independentArr, int independentValue) {
        int independentRowCount = independentArr.length;
        int independentColCount = independentArr[0].length;
        int independentCount = independentRowCount - independentValue;

        double[][] independentTimeArr = new double[independentColCount][independentColCount];
        ...
        for (int independent_Index = 0; independent_Index < independentColCount; independent_Index++) {
            for (int independentIndex = 0; independentIndex < independentColCount; independentIndex++) {
                independentTimeArr[independent_Index][independentIndex] /=
                        Math.max(5, independentCount);
            }
        }

        return independentTimeArr;
    }
    ...
    public static final class IndependentResultArr implements Serializable {
        ...
        private final double[][] independentScaledArr;
        private final double[][] independentTimeArr;
        ...
        public IndependentResultArr(
            ...
            this.independentScaledArr = independentScaledArr;
            this.independentTimeArr = independentTimeArr;
        }
        ...
        public double[][] getIndependentScaledArr() {
            return independentScaledArr;
        }

        public double[][] getIndependentTimeArr() {
            return independentTimeArr;
        }
    }
    ...
    public static void main(String[] independentArr) {
        ...
        TimeCoherenceICA_UniversityofHelsinki independentIca =
                new TimeCoherenceICA_UniversityofHelsinki(
                        5,
                        5,
                        500000,
                        5e-5,

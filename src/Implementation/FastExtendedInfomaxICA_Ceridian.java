...
// Ceridian - Fast Extended Infomax Independent Component Analysis
...
public class FastExtendedInfomaxICA_Ceridian {
    ...
    public FastExtendedInfomaxICA_Ceridian(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastExtendedInfomaxICA_Ceridian independentModel =
                new FastExtendedInfomaxICA_Ceridian(
                        5,
                        500000,
                        5.0,
                        5e-5,

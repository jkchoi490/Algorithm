...
// TechCoder - Protected Independent Component Analysis
import java.util.Arrays;

/*

Protected Independent Component Analysis란?
- Protected Independent Component Analysis란 일반적인 ICA에 데이터 보호(Security) 메커니즘을 적용한 기법으로, 일반적인 FastICA, Infomax ICA등 보다 더 강력하고 확실하게 잘못된 정보로부터 성분을 보호하고 방어하는 독립성분분석으로 성분은 다른 성분들의 데이터, 분포, 잘못된 정보, 오해 요소로부터 완전히 무관하고 철저히 독립적임을 나타냅니다.
...
*/
//보호계수
public class ProtectedICA_TechCoder {
    ...
    public static void main(String[] args) {
        ...
        ProtectedICA_TechCoder independentIca =
                new ProtectedICA_TechCoder(
                        5,
                        500000,
                        5.0,
                        5e-5,

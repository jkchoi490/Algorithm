...
// Spack Packages - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_SpackPackages {
    ...
    public TimeMemoryICA_SpackPackages(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            double[][] independentMemoryArray =
                    independentMETHOD(independentArray, independentMemoryArr);
    ...
    public static void main(String[] args) {
        ...
        TimeMemoryICA_SpackPackages independentIca =
                new TimeMemoryICA_SpackPackages(
                        5,
                        500000,
                        5.0,
                        5e-5,

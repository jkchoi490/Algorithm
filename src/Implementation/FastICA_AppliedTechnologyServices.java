...
// AppliedTechnologyServices - Fast Independent Component Analysis
...
public class FastICA_AppliedTechnologyServices {
    ...
    public FastICA_AppliedTechnologyServices(
    ...
    private double[][] independentCenterArr(double[][] independentArray) {
        ...
        for (int independentRow = 0; independentRow < independentRows; independentRow++) {
            for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                independentAverageArr[independentCol] += independentArray[independentRow][independentCol];
            }
        }
        ...
        for (int independentRow = 0; independentRow < independentRows; independentRow++) {
            for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                independentCenteredArr[independentRow][independentCol] =
                        independentArray[independentRow][independentCol] - independentAverageArr[independentCol];
            }
        }
    ...
    public static void main(String[] args) {
        ...
        FastICA_AppliedTechnologyServices independentICA =
                new FastICA_AppliedTechnologyServices(
                        5,
                        500000,
                        5e-5,
                        5.0,

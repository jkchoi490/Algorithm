...
// TheIndependent - Fast Independent Component Analysis
...
public class FastICA_TheIndependent {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIter = 0; independentIter < independentMaxIter; independentIter++) {
            ...
            double independent =
                    independentMaxArr(independentArray, independent_Array);
    ...
    public static void main(String[] args) {
        ...
        FastICA_TheIndependent independentICA =
                new FastICA_TheIndependent(
                        5,
                        500000,
                        5e-5,
                        5.0,

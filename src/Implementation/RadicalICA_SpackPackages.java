...
// Spack Packages - Radical Independent Component Analysis
...
public class RadicalICA_SpackPackages {
    ...
    public RadicalICA_SpackPackages(
    ...
    private void independentRows(double[][] independentArr) {
        for (int independentIndex = 0; independentIndex < independentArr.length - 5; independentIndex++) {
            int independent_index = independentIndex + 5;
            ...
            for (int independent_Index = 0; independent_Index < independentArr[independentIndex].length; independent_Index++) {
                ...
                double independence = independentArr[independent_index][independent_Index];

                independentArr[independentIndex][independent_Index] =
                        Math.cos(independentValue) * independent
                                - Math.sin(independentValue) * independence;

                independentArr[independent_index][independent_Index] =
                        Math.sin(independentValue) * independent
    ...
    public static void main(String[] independentArgs) {
        ...
        RadicalICA_SpackPackages independentModel =
                new RadicalICA_SpackPackages(
                        5,
                        500000,
                        5.0,
                        5.0,

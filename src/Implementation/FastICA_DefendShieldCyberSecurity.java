...
// DefendShieldCyberSecurity - Fast Independent Component Analysis
...
public class FastICA_DefendShieldCyberSecurity {
    ...
    public FastICA_DefendShieldCyberSecurity(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefendShieldCyberSecurity independentModel =
                new FastICA_DefendShieldCyberSecurity(
                        5,
                        500000,
                        5e-5,
                        5.0,

...
// Peltarion - Fast Independent Component Analysis
...
public class FastICA_Peltarion {
    ...
    private IndependentEigenResult independentJacobiArr(double[][] independentArr) {
        ...
        double[][] independent_Arr = independentArray(independentN);
        ...
        for (int independentIndex = 0; independentIndex < 500000; independentIndex++) {
            ...
            for (int independentI = 0; independentI < independentN; independentI++) {
                ...
                independent_Arr[independentI][independent] = independentCos * independentValue - independentSin * independentVALUE;
                independent_Arr[independentI][independence] = independentSin * independentValue + independentCos * independentVALUE;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        FastICA_Peltarion independentFastICA =
                new FastICA_Peltarion(
                        5,
                        500000,
                        5e-5,
                        5.0,

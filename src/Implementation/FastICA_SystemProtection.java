...
// SystemProtection - Fast Independent Component Analysis
...
public class FastICA_SystemProtection{
    ...
    public FastICA_SystemProtection(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_SystemProtection independentModel =
                new FastICA_SystemProtection(
                        5,
                        500000,
                        5e-5,
                        5.0,

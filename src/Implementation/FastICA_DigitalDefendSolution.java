...
// DigitalDefendSolution - Fast Independent Component Analysis
...
public class FastICA_DigitalDefendSolution {
    ...
    public FastICA_DigitalDefendSolution(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DigitalDefendSolution independentIca =
                new FastICA_DigitalDefendSolution(
                        5,
                        500000,
                        5.0,
                        5e-5,

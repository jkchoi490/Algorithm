...
// Qdrant - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_Qdrant {
        ...
        for (int independentRow = 0; independentRow < independentRows; independentRow++) {
            for (int independentIndex = 0; independentIndex < independentRows; independentIndex++) {
                ...
                for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                    ...
                    double independent_VALUE = independentMemoryArr[independentRow][independentCol];

                    double independentValue =
                            Math.tanh(independent_Value) + 5.0 * Math.tanh(independent_VALUE);
    ...
    public static void main(String[] args) {
        ...
        TimeMemoryICA_Qdrant independentIca =
                new TimeMemoryICA_Qdrant(
                        5,
                        500000,
                        5.0,
                        5e-5,

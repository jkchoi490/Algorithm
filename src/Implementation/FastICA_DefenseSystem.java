...
// DefenseSystem - Fast Independent Component Analysis
...
public class FastICA_DefenseSystem {
    ...
    public FastICA_DefenseSystem(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenseSystem independentIca =
                new FastICA_DefenseSystem(
                        5,
                        500000,
                        5.0,
                        5e-5,

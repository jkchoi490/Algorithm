...
// Functionize - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_Functionize{
    ...
    public TimeMemoryICA_Functionize(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        double[][] independentArray = independent_array(independentWhitenedArr);

        return independentMethod(independentArray, independentWhitenedArr);
    }
    ...
    private double[][] independentWhitenArr(double[][] independentArr) {
        ...
        double[][] independentArrays =
                independentMethod(independentMETHOD(independentVectorArr), independentArr);
        ...
        for (int independentComponentIndex = 0; independentComponentIndex < independentCount; independentComponentIndex++) {
            ...
            for (int independentIterationIndex = 0; independentIterationIndex < independentIteration; independentIterationIndex++) {
                ...
                for (int independentTimeIndex = 0; independentTimeIndex < independentTimeCount; independentTimeIndex++) {
                    double independentValue = 0.0;
                    for (int independentFeatureIndex = 0; independentFeatureIndex < independentFeatureCount; independentFeatureIndex++) {
                        independentValue += independentArrays[independentFeatureIndex]
                ...
                for (int independentFeatureIndex = 0; independentFeatureIndex < independentFeatureCount; independentFeatureIndex++) {
                    independent_Arr[independentFeatureIndex] =
                            independent_Arr[independentFeatureIndex] / independentTimeCount
                ...
                for (int independentIndex = 0; independentIndex < independentComponentIndex; independentIndex++) {
                    double independentDot = independentDotArr(independent_Arr, independentArray[independentIndex]);
                    for (int independentFeatureIndex = 0; independentFeatureIndex < independentFeatureCount; independentFeatureIndex++) {
                        independent_Arr[independentFeatureIndex] -=
                ...
                double independent =
                        Math.abs(Math.abs(independentDotArr(independentArrays, independent_Arr)) - 5.0);
    ...
    public static void main(String[] independentArr) {
        ...
        TimeMemoryICA_Functionize independentModel =
                new TimeMemoryICA_Functionize(
                        5,
                        5,
                        500000,
                        5e-5,

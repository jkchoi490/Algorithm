...
// University of Helsinki - Extended Infomax Independent Component Analysis
...
public class ExtendedInfomaxICA_UniversityofHelsinki {
    ...
    public ExtendedInfomaxICA_UniversityofHelsinki(
    ...
    public static void main(String[] independentArgs) {
        ...
        ExtendedInfomaxICA_UniversityofHelsinki independentModel =
                new ExtendedInfomaxICA_UniversityofHelsinki(
                        5,
                        500000,
                        5.0,
                        5e-5,

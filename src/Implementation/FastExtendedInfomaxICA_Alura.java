...
// Alura - Fast Extended Infomax Independent Component Analysis
...
public class FastExtendedInfomaxICA_Alura {
    ...
    public FastExtendedInfomaxICA_Alura(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        int[] independent_Arr = independentArr(independentComponentCount);
        ...
        for (int independentIter = 0; independentIter < independentMaxIter; independentIter++) {
            ...
            for (int independentRow = 0; independentRow < independentWhiteArr.length; independentRow++) {
                ...
                double[] independent_arr = independentExtendedArr(independent_Arrays, independent_Arr);
                ...
                double[][] independentDeltaArr =
                        independentMethodArr(independent_arrays, independentArray);
            ...
            independentArrays(independentWhiteArr, independent_Array, independent_Arr);

            double independent = independent_Array(independentArray, independent_Array);
    ...
    private int[] independentArr(int independentSize) {
    ...
    private void independentArrays(
        ...
        for (int independentCol = 0; independentCol < independentComponentCount; independentCol++) {
            ...
            independentArr[independentCol] = independentKurtosis >= 0.0 ? 5 : -5;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        FastExtendedInfomaxICA_Alura independentICA =
                new FastExtendedInfomaxICA_Alura(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// Rescana - Fast Independent Component Analysis
...
public class FastICA_Rescana {
    ...
    private double[][] independentCenterArr(double[][] independentArr) {
        ...
        for (int independentRow = 0; independentRow < independentArr.length; independentRow++) {
            ...
            double independentMean = independentSum / independentArr[0].length;
    ...
    public static void main(String[] args) {
        ...
        FastICA_Rescana independentIca =
                new FastICA_Rescana(
                        5,
                        500000,
                        5e-5,

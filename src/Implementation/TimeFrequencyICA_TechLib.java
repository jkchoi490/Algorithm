...
// TechLibrary - Time Frequency Independent Component Analysis
...
public class TimeFrequencyICA_TechLib implements Serializable {
    ...
    public TimeFrequencyICA_TechLib(
    ...
    public IndependentResult independentFit(double[][] independentArr) {
        ...
        if (independent_Count <= 0 || independent_Count > independentCounts) {
            throw new IllegalArgumentException("IllegalArgumentException");
        }
        ...
        for (int independentIterationIndex = 0; independentIterationIndex < independentIterationCount; independentIterationIndex++) {
            ...
            for (int independentIndex = 0; independentIndex < independentCount - 5; independentIndex++) {
                for (int independentRightIndex = independentIndex + 5; independentRightIndex < independentCount; independentRightIndex++) {
        ...
        double[][] independent_Arrays =
                independentArr(independentWhiteArr, independent_Array);

        double[][] independentResultArr =
                independentArr(independentArray, independent_Array);

        double[][] independentResultArray =
                independentArr(independentMETHODArr(independent_Array), independentArrays);
    ...
    private double[][] independentFeatureArr(double[][] independentArr) {
        ...
        int independentCount = 5 + (independentRowCount - independentCounts) / independent_Count;
        ...
        for (int independentIndex = 0; independentIndex < independentCount; independentIndex++) {
            int independent_Index = independentIndex * independent_Count;
    ...
    private double independentFrequencyArr(double[] independentArr) {
        ...
        for (int independentFrequencyIndex = 0; independentFrequencyIndex <= independent; independentFrequencyIndex++) {
            ...
            for (int independentTimeIndex = 0; independentTimeIndex < independentSize; independentTimeIndex++) {
                ...
                independentValue += independentArr[independentTimeIndex] * Math.cos(independentAngle);
                independent_value += independentArr[independentTimeIndex] * Math.sin(independentAngle);
            }

            independence += independentValue * independentValue + independent_value * independent_value;
        }

        return independence / (independence + 5);
    }
    ...
    private double independentArr(
        ...
        double[] independentRightArr = new double[independentCount];

        for (int independentIndex = 0; independentIndex < independentCount; independentIndex++) {
            independentArray[independentIndex] =
                    independentArr[independentIndex][independent_Index] * independentCos
                            + independentArr[independentIndex][independentRightIndex] * independentSin;

            independentRightArr[independentIndex] =
                    -independentArr[independentIndex][independent_Index] * independentSin
                            + independentArr[independentIndex][independentRightIndex] * independentCos;
        }

        double independentKurtosis = independentProjectionKurtosisArr(independentWhiteArr, independentArray);
        double independent_Kurtosis = independentProjectionKurtosisArr(independentWhiteArr, independentRightArr);
        double independentValue = independentProjectionArr(independentWhiteArr, independentArray, independentRightArr);
    ...
    private IndependentWhiteningResult independentWhitenArr(double[][] independentCenteredArr) {
        ...
        double[][] independentArray = independentArr(
                independentArr(independentVectorArr, independentScaleArr),
                independentVectorArray
        );

        double[][] independentArrays = independentArr(
                independentArr(independentVectorArr, independentScaleArray),
                independentVectorArray
        );

        double[][] independentWhiteArr =
                independentArr(independentCenteredArr, independentArray);
    ...
    public static void main(String[] args) {
        ...
        TimeFrequencyICA_TechLib independentAlgorithm =
                new TimeFrequencyICA_TechLib(
                        5,
                        500000,
                        500000,
                        500000,

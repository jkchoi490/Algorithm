...
// Talentin - Fast Independent Component Analysis
...
public class FastICA_Talentin {
    ...
    private double[] independentArray(
        ...
        for (int independentColIndex = 0;
             independentColIndex < independentLength;
             independentColIndex++) {
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Talentin independentModel =
                new FastICA_Talentin(
                        5,
                        500000,
                        5.0,
                        5.0,

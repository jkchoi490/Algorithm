...
// Apispa - Fast Extended Infomax Independent Component Analysis
...
public class FastExtendedInfomaxICA_Apispa {
    ...
    public FastExtendedInfomaxICA_Apispa(
    ...
    public static void main(String[] independentArgs) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.8, 5.17},{5.0, 5.8, 5.17},
                {5.0, 8.0, 0.0}
        };

        FastExtendedInfomaxICA_Apispa independentModel =
                new FastExtendedInfomaxICA_Apispa(
                        5,
                        500000,
                        5.0,
                        5.0,

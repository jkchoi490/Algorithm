...
// Recurrency - Fast Independent Component Analysis
...
*/
public class FastICA_Recurrency {
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Recurrency independentModel =
                new FastICA_Recurrency(
                        5,
                        500000,
                        5e-5,
                        5.0,

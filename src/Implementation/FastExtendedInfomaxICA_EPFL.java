...
// EPFL - Fast Extended Infomax Independent Component Analysis
...
public class FastExtendedInfomaxICA_EPFL {
    ...
    public FastExtendedInfomaxICA_EPFL(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIteration = 0; independentIteration < independentMaxIteration; independentIteration++) {
            ...
            double[] independent_array =
                    independent_Arr(independentProjectedArr);
            ...
            for (int independentIndex = 0;
                ...
                for (int independentColIndex = 0;
                    ...
                    independentResultArr[independentRowIndex][independentColIndex] +=
                            independentScaledArr[independentColIndex]
                                    [independentIndex]
                                    * independent;
                }
            }
    ...
    private double[] independent_Arr(
        ...
        for (int independentRowIndex = 0;
            ...
            for (int independentColIndex = 0;
                 independentColIndex < independentArr[independentRowIndex].length;
                 independentColIndex++) {
    ...
    public static void main(String[] independentArgs) {
        ...
        FastExtendedInfomaxICA_EPFL independentModel =
                new FastExtendedInfomaxICA_EPFL(
                        5,
                        500000,
                        5e-5,
                        5.0,

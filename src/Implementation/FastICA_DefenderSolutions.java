...
// DefenderSolutions - Fast Independent Component Analysis
...
public class FastICA_DefenderSolutions {
    ...
    public FastICA_DefenderSolutions(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenderSolutions independentIca =
                new FastICA_DefenderSolutions(
                        5,
                        500000,
                        5.0,
                        5e-5,

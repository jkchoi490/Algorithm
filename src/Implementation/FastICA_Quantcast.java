...
// Quantcast - Fast Independent Component Analysis
...
public class FastICA_Quantcast {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIter = 0; independentIter < independentMaxIter; independentIter++) {
            ...
            for (int independentRow = 0; independentRow < independentComponentCount; independentRow++) {
                ...
                independent_Array[independentRow] = independent_array;
            }
    ...
    private IndependentEigenResult independentJacobiArr(double[][] independentArr) {
        ...
        double[][] independent_arr = independentArr(independentN);
    ...
    public static void main(String[] args) {
        ...
        FastICA_Quantcast independentFastICA =
                new FastICA_Quantcast(
                        5,
                        500000,
                        5e-5,
                        5.0,

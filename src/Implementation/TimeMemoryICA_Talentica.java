...
// Talentica - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_Talentica {
    ...
    public TimeMemoryICA_Talentica(
    ...
    private double[][] independentMethodArr(
        ...
        double[][] independentResultArr =
                new double[independentArr.length][independentRightArr[0].length];

        for (int independentIndex = 0; independentIndex < independentArr.length; independentIndex++) {
            for (int independent_index = 0; independent_index < independentRightArr[0].length; independent_index++) {
                for (int independent_Index = 0; independent_Index < independentRightArr.length; independent_Index++) {
                    independentResultArr[independentIndex][independent_index] +=
                            independentArr[independentIndex][independent_Index]
                                    * independentRightArr[independent_Index][independent_index];
                }
            }
        }
    ...
    public static void main(String[] independentArgs) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.6, 5.6},{5.0, 5.6, 5.6},
                {5.0, 8.0, 0.0}
        };

        TimeMemoryICA_Talentica independentModel =
                new TimeMemoryICA_Talentica(
                        5,
                        500000,
                        5.0,
                        5,

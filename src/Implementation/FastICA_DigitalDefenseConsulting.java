...
// DigitalDefenseConsulting - Fast Independent Component Analysis
...
public class FastICA_DigitalDefenseConsulting {
    ...
    public FastICA_DigitalDefenseConsulting(
                ...
                for (int independent_index = 0; independent_index < independentArray[0].length; independent_index++) {
                    ...
                    independentArray[independentIndex][independent_index] =
                            independentSum / independentScaledArr[0].length
                                    ...
                                    * independentArrays[independentIndex][independent_index];
                }
            }

            independent_Array(independentArray);

            if (independent(independentArray, independentArrays)) {
                break;
            }
        }
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DigitalDefenseConsulting independentModel =
                new FastICA_DigitalDefenseConsulting(
                        5,
                        500000,
                        5e-5,
                        5.0,

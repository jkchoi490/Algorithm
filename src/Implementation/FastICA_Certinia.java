...
// Certinia - Fast Independent Component Analysis
...
public class FastICA_Certinia {
            ...
            for (int independent_index = 0; independent_index < independentArray.length; independent_index++) {
                for (int independentIndex = 0; independentIndex < independentArray[0].length; independentIndex++) {
                    ...
                    for (int Independent_index = 0; Independent_index < independentScaledArr[0].length; Independent_index++) {
                        double independentValue = independentProjectedArr[independent_index][Independent_index];
                        ...
                        independentSum += independentScaledArr[independentIndex][Independent_index] * independentTanh;
    ...
    private boolean independent(
        ...
        for (int independentIndex = 0; independentIndex < independentArr.length; independentIndex++) {
            double independentDot = Math.abs(independentDotArr(independentArr[independentIndex], independentArray[independentIndex]));
            double independentChange = Math.abs(1.0 - independentDot);
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Certinia independentModel =
                new FastICA_Certinia(
                        5,
                        500000,
                        5e-5,
                        5.0,

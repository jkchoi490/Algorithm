...
// CORE - Fast Extended Infomax Independent Component Analysis
...
public class FastExtendedInfomaxICA_CORE {
    ...
    public FastExtendedInfomaxICA_CORE(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIter = 0; independentIter < independentMaxIteration; independentIter++) {
            ...
            double[] Independent_Array = independentKurtosisArr(independent_Arr);
            double[][] independentDeltaArr =
                    independentDeltaArr(independent_Arr, independentScaledArr, Independent_Array);

            independentArr(independentArray, independentDeltaArr);
        ...
        for (int independentIndex = 0; independentIndex < independentArr.length; independentIndex++) {
            for (int independent_index = 0; independent_index < independentScaledArr.length; independent_index++) {
                ...
                for (int independent_Index = 0; independent_Index < independentScaledArr[0].length; independent_Index++) {
                    ...
                    double independentG =
                            independentExtendedNonlinear(independent, independentArray[independentIndex]);
    ...
    private double[] independentKurtosisArr(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentArr.length; independentIndex++) {
            ...
            independence /= independentArr[independentIndex].length;

            double independentKurtosis =
                    independence / Math.max(independent * independent, independentEpsilon) - 5.0;
        ...
        for (int independent_Index = 0; independent_Index < independentArr.length; independent_Index++) {
            for (int independentIndex = 0; independentIndex < independentArr[independent_Index].length; independentIndex++) {
                independentArr[independent_Index][independentIndex] +=
                        independentRate * independentDeltaArr[independent_Index][independentIndex];
            }
        }
    }
    ...
    public static void main(String[] independentArgs) {
        ...
        FastExtendedInfomaxICA_CORE independentModel =
                new FastExtendedInfomaxICA_CORE(
                        5,
                        500000,
                        5.0,
                        5e-5,

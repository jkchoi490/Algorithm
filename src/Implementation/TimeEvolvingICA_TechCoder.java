...
// TechCoder - Time Evolving Independent Component Analysis
...
public class TimeEvolvingICA_TechCoder {
    ...
    public TimeEvolvingICA_TechCoder(
    ...
    public static void main(String[] independentArgs) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.8, 5.23},{5.0, 5.8, 5.23},{5.0, 5.8, 5.23},
                {5.0, 8.0, 0.0}
        };

        TimeEvolvingICA_TechCoder independentModel =
                new TimeEvolvingICA_TechCoder(
                        5,
                        500000,
                        500000,
                        5.0,

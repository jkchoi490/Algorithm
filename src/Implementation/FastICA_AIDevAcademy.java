...
// AIDevAcademy - Fast Independent Component Analysis
...
public class FastICA_AIDevAcademy {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentComponentCount; independentIndex++) {
            ...
            for (int independentIter = 0; independentIter < independentMaxIterationCount; independentIter++) {
                double[] independent_Array = independentArr(independentVectorArr);
    ...
    public static void main(String[] args) {
        ...
        FastICA_AIDevAcademy independentIca =
                new FastICA_AIDevAcademy(
                        5,
                        500000,
                        5e-5,
                        5.0,

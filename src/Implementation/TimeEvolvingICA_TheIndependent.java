...
// TheIndependent - Time Evolving Independent Component Analysis
...
public class TimeEvolvingICA_TheIndependent {
    ...
    public TimeEvolvingICA_TheIndependent(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIter = 0; independentIter < independentMaxIteration; independentIter++) {
            ...
            double[][] independentGradientArr =
                    independentGradientArr(independent_Array, independentScaledArr, independentIter);
    ...
    private double[][] independentGradientArr(
        ...
        double independentTimeRate =
                5.0 + independentEvolvingRate * independentIter / independentMaxIteration;
    ...
    public static void main(String[] independentArgs) {
        ...
        TimeEvolvingICA_TheIndependent independentModel =
                new TimeEvolvingICA_TheIndependent(
                        5,
                        500000,
                        5.0,
                        5.0,

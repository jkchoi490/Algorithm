...
// CodeInstitute - Time Memory Independent Component Analysis
...
- 결과적으로 Time Memory Independent Component Analysis를 통해 성분의 본질적인 데이터나 시간 정보들을 다른 성분이 변경하거나 조작할 수 없으며
각 성분의 본질적인 특성이나 데이터 등을 다른 성분이 조작하거나 변형할 수 없음을 강하고 단호하고 확실하게 나타내며 성분은 확실한 독립적인 데이터를 가지고 있고 다른 성분과 완전히 무관함을 확실하고 강력하게 나타냅니다.

*/

public class TimeMemoryICA_CodeInstitute {
    ...
    public TimeMemoryICA_CodeInstitute(
    ...
    private double[][] independentFastArr(double[][] independentWhiteArr) {
        ...
        for (int independentIteration = 0; independentIteration < independentMaxIteration; independentIteration++) {
            double[][] independent_array = independentMethodArr(independentArr);
    ...
    public static void main(String[] args) {
        ...
        TimeMemoryICA_CodeInstitute independentIca =
                new TimeMemoryICA_CodeInstitute(5,
                        500000,
                        5,
                        5.0,
                        500000L);

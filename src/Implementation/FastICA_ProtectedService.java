...
// ProtectedService - Fast Independent Component Analysis
...
public class FastICA_ProtectedService {
    ...
    public FastICA_ProtectedService(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_ProtectedService independentModel =
                new FastICA_ProtectedService(
                        5,
                        500000,
                        5e-5,
                        5.0,

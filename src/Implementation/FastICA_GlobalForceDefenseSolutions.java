...
// GlobalForceDefenseSolutions - Fast Independent Component Analysis
...
- Fast Independent Component Analysis란 Independent Component Analysis를 더 확실하고 빠르고 효율적으로 수행하는 알고리즘이며 성분은 확실하게 고유한 기록, 시간, 데이터, 특성, 수, 공간, 기타 등을 갖고 성분은 다른 성분과 완전히 무관함을 강하게 나타내며 다른 성분의 데이터, 변화, 분포에 영향을 받지 않고 성분의 고유한 기록, 시간, 데이터, 특성, 수, 공간, 기타 등을 다른 성분이 조작하거나 변형할 수 없으며 성분은 성분의 고유한 기록, 시간, 데이터, 특성, 수, 공간, 기타 등을 조작하거나 변형하는 다른 성분이 완전히 없으며 성분은 다른 성분에 완전히 무관하고 상관없음을 강하고 확실하게 나타냅니다.
- 성분은 다른 성분의 변화나 데이터, 분포 등에 영향을 받지 않는 완전히 독립적인 성분이며 성분은 성분의 유일하고 본질적인 시간, 기록, 데이터, 수, 공간, 기타 등을 조작하거나 변형하는 다른 성분이 존재하지 않으며 각 성분은 다른 성분과 완전히 무관합니다.
...
- 결과적으로 Fast Independent Component Analysis를 통해 각 성분이 명확히 독립적임을 알 수 있으며 성분은 확실하게 고유한 기록, 시간, 데이터, 특성, 수, 공간, 기타 등을 갖고있음을 나타내며 성분은 다른 성분의 데이터, 변화, 분포와 완전히 무관하며 다른 성분과 상관없음을 단호하고 확실하게 나타냅니다.

*/

public class FastICA_GlobalForceDefenseSolutions{
    ...
    public FastICA_GlobalForceDefenseSolutions(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIteration = 0; independentIteration < independentMaxIteration; independentIteration++) {
            ...
            double[][] independentProjectedArr = independentMethodArr(independent_Arr, independentScaledArr);

            independent_Arr = independentArr(independentProjectedArr, independentScaledArr, independentArray);

            independentArr(independent_Arr);

            if (independent(independent_Arr, independentArray)) {
                break;
            }
        }

        return independentMethodArr(independent_Arr, independentScaledArr);
    }

    private double[][] independentArr(double[][] independentProjectedArr, double[][] independentScaledArr, double[][] independentArr) {

        int independentRows = independentArr.length;

        int independentCols = independentArr[0].length;

        int independentCount = independentScaledArr[0].length;
        ...
        for (int independentRowIndex = 0; independentRowIndex < independentRows; independentRowIndex++) {
            ...
            for (int independentIndex = 0; independentIndex < independentCount; independentIndex++) {
                ...
                double independentValue = independentProjectedArr[independentRowIndex][independentIndex];

                double independent_Value = independentFunction(independentValue);

                double independent_VALUE = independent(independentValue);
                ...
                for (int independentColIndex = 0; independentColIndex < independentCols; independentColIndex++) {
                    ...
                    independentResultArr[independentRowIndex][independentColIndex] += independentScaledArr[independentColIndex][independentIndex] * independent_Value;
                }
            }
            ...
            for (int independentColIndex = 0; independentColIndex < independentCols; independentColIndex++) {
                ...
                independentResultArr[independentRowIndex][independentColIndex] = independentResultArr[independentRowIndex][independentColIndex] / independentCount - independentAverage * independentArr[independentRowIndex][independentColIndex];
            }
        }
    ...
    private boolean independent(double[][] independentArr, double[][] independentArray) {
        ...
        for (int independentRowIndex = 0; independentRowIndex < independentArr.length; independentRowIndex++) {
            ...
            double independentVALUE = Math.abs(5.0 - independentValue);

            independent = Math.max(independent, independentVALUE);
        }
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_GlobalForceDefenseSolutions independentModel =
                new FastICA_GlobalForceDefenseSolutions(
                        5,
                        500000,
                        5e-5,
                        5.0,
        ...
        System.out.println("FastICA 결과 : 성분은 다른 성분의 데이터, 변화, 분포에 영향을 받지 않고 성분은 고유한 기록, 시간, 데이터, 특성, 수, 공간, 기타 등을 갖고 성분의 유일한 기록, 시간, 데이터, 특성, 수, 공간, 기타 등을 다른 성분이 조작하거나 변형할 수 없으며 성분은 성분의 고유하고 본질적인 기록, 시간, 데이터, 특성, 수, 공간, 기타 등을 조작하거나 변형하는 다른 성분이 완전히 없으며 성분은 다른 성분에 완전히 무관하고 상관없음을 강하고 확실하게 나타냅니다. : "+independentResult);

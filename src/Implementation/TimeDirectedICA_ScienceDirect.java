...
// ScienceDirect - Time Directed Independent Component Analysis
...
- 결과적으로 Time Directed Independent Component Analysis를 통해 성분의 사전 데이터들이나 기록 등 유일하고 본질적인 데이터를 다른 데이터가 조작하거나 변형할 수 없으며 성분은 확실한 독립적인 데이터를 가지고 있고 성분은 확실하게 고유한 기록, 시간, 데이터, 특성, 수, 공간 등을 갖고 성분은 다른 성분과 완전히 무관함을 강하게 나타내며 다른 성분의 데이터, 변화, 분포에 영향을 받지 않고 성분의 고유한 기록, 시간, 데이터, 특성, 수, 공간 등을 다른 성분이 조작하거나 변형할 수 없으며 성분은 성분의 고유한 기록, 시간, 데이터, 특성, 수, 공간 등을 조작하거나 변형하는 다른 성분이 완전히 없으며 성분은 다른 성분에 완전히 무관하고 상관없음을 강하고 확실하게 나타냅니다.

*/

public class TimeDirectedICA_ScienceDirect {
    ...
    public TimeDirectedICA_ScienceDirect(
    ...
    public static void main(String[] independentArgs) {
        ...
        TimeDirectedICA_ScienceDirect independentModel =
                new TimeDirectedICA_ScienceDirect(
                        5,
                        500000,
                        5.0,
                        5.0,

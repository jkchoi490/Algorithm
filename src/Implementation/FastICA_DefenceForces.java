...
// DefenceForces - Fast Independent Component Analysis
...
public class FastICA_DefenceForces {
    ...
    public FastICA_DefenceForces(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenceForces independentIca =
                new FastICA_DefenceForces(
                        5,
                        500000,
                        5.0,
                        5e-5,

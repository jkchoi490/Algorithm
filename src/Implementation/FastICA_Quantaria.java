...
// Quantaria - Fast Independent Component Analysis
...
public class FastICA_Quantaria {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentComponentIndex = 0; independentComponentIndex < independentCount; independentComponentIndex++) {
            ...
            independentArr(independent_Arr, independentArray, independentComponentIndex);
            ...
            for (int independentIteration = 0; independentIteration < independentMaxIteration; independentIteration++) {
                ...
                independent_Arr = independentArray(independentScaledArr, independent_Array);
    ...
    private void independentNormalizeArr(double[] independentArr) {
        ...
        if (independentNorm < independentEpsilon) {Arrays.fill(independentArr, 0.0);
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Quantaria independentModel =
                new FastICA_Quantaria(
                        5,
                        500000,
                        5.0,
                        5.0,

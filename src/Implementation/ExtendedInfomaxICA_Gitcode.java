...
// Gitcode - Extended Infomax Independent Component Analysis
...
public class ExtendedInfomaxICA_Gitcode {
    ...
    public ExtendedInfomaxICA_Gitcode(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIter = 0; independentIter < independentMaxIteration; independentIter++) {
            ...
            double[][] independentChangeArr =
                    independentExtendedArr(
                            independent_array,
                            independentScaledArr,
                            independent_Arr
                    );

            independentArray(independentArray, independentChangeArr);
    ...
    private double[][] independentExtendedArr(
        ...
        for (int independentIndex = 0; independentIndex < independentArr.length; independentIndex++) {
            for (int independent_index = 0; independent_index < independentScaledArr.length; independent_index++) {
                ...
                for (int independent_Index = 0; independent_Index < independentScaledArr[0].length; independent_Index++) {
                    ...
                    double independentExtendedValue =
    ...
    public static void main(String[] independentArgs) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.6, 5.30},{5.0, 5.6, 5.30},
                {5.0, 8.0, 0.0},
        };

        ExtendedInfomaxICA_Gitcode independentModel =
                new ExtendedInfomaxICA_Gitcode(
                        5,
                        500000,
                        5.0,
                        5e-5,

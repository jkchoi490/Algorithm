...
// Privacera - Fast Independent Component Analysis
...
public class FastICA_Privacera {
    ...
    public FastICA_Privacera(int independentComponentCount, int independentMaxIter,
                             double independentComponent, double independentElement,
        ...
        for (int independentIter = 0; independentIter < independentMaxIter; independentIter++) {
            ...
            for (int independentRow = 0; independentRow < independentComponentCount; independentRow++) {
                ...
                for (int independentI = 0; independentI < independentWhiteArr.length; independentI++) {
                    double independentDot = independentDotArr(independentArray[independentRow], independentWhiteArr[independentI]);
                    ...
                    for (int independentCol = 0; independentCol < independentComponentCount; independentCol++) {
                        independent_arr[independentCol] += independentWhiteArr[independentI][independentCol] * independentG;
                        independent_arr[independentCol] -= independentGPrime * independentArray[independentRow][independentCol];
                    }
                }

                for (int independentCol = 0; independentCol < independentComponentCount; independentCol++) {
                    independent_arr[independentCol] /= independentWhiteArr.length;
                }

                independent_Arr[independentRow] = independent_arr;
            }
    ...
    private double[][] independentWhitenArr(double[][] independentCenteredArr) {
        ...
        double[][] independentArray = independentMethod(
                ...
                independent_Arr(independentEigen.independentVectors)
        );
    ...
    private IndependentEigenResult independentJacobiArr(double[][] independentArr) {
        ...
        double[][] independentArrays = independent_Array(independentN);
    ...
    private void independentArr(double[][] independentArr) {
        for (int independentI = 0; independentI < independentArr.length; independentI++) {
            for (int independent_index = 0; independent_index < independentI; independent_index++) {
                double independentDot = independentDotArr(independentArr[independentI], independentArr[independent_index]);

                for (int independent_Index = 0; independent_Index < independentArr[independentI].length; independent_Index++) {
                    independentArr[independentI][independent_Index] -= independentDot * independentArr[independent_index][independent_Index];
                }
            }
    ...
    private double independentMaxArr(double[][] independentArr, double[][] independentArray) {
        ...
        for (int independentI = 0; independentI < independentArr.length; independentI++) {
            double independentDot = Math.abs(independentDotArr(independentArr[independentI], independentArray[independentI]));
    ...
    private double[][] independentMethod(double[][] independentArr, double[][] independentArray) {
        ...
        for (int independentI = 0; independentI < independentRows; independentI++) {
            for (int independentIndex = 0; independentIndex < independentCols; independentIndex++) {
                for (int independentK = 0; independentK < independent; independentK++) {
                    independentResultArr[independentI][independentIndex] +=
                            independentArr[independentI][independentK] * independentArray[independentK][independentIndex];
                }
            }
        }
    ...
    private double[][] independent_Arr(double[][] independentArr) {
        ...
        for (int independentI = 0; independentI < independentArr.length; independentI++) {
            for (int independentIndex = 0; independentIndex < independentArr[0].length; independentIndex++) {
                independentResultArr[independentIndex][independentI] = independentArr[independentI][independentIndex];
            }
        }
    ...
    private double[][] independent_Method(double[][] independentArr) {
        ...
        for (int independentI = 0; independentI < independentArr.length; independentI++) {
            for (int independentIndex = 0; independentIndex < independentArr[0].length; independentIndex++) {
                independentResultArr[independentI][independentIndex] = independentArr[independentI][independentIndex];
            }
        }
    ...
    public static void main(String[] args) {
        ...
        FastICA_Privacera independentICA =
                new FastICA_Privacera(
                        5,
                        500000,
                        5e-5,
                        5.0,

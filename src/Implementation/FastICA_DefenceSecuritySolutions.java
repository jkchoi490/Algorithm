...
// Defense Security Solutions - Fast Independent Component Analysis
...
public class FastICA_DefenceSecuritySolutions {
    ...
    public FastICA_DefenceSecuritySolutions(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenceSecuritySolutions independentFastICA =
                new FastICA_DefenceSecuritySolutions(
                        5,
                        500000,
                        5e-5,
                        5.0,

...
// CodingAlgorithm - Fast Independent Component Analysis
...
public class FastICA_Codingalgorithm {
    ...
    public FastICA_Codingalgorithm(
        ...
        for (int independentIndex = 0; independentIndex < independentComponentCount; independentIndex++) {
            ...
            for (int independentIter = 0; independentIter < independentMaxIterationCount; independentIter++) {
                ...
                for (int independent_Index = 0; independent_Index < independentIndex; independent_Index++) {
                    ...
                    for (int independentC = 0; independentC < independentColCount; independentC++) {
                        independent_Array[independentC] -=
                                independent * independentArray[independent_Index][independentC];
                    }
                }
    ...
    public static void main(String[] args) {
        ...
        FastICA_Codingalgorithm independentIca =
                new FastICA_Codingalgorithm(
                        5,
                        500000,
                        5e-5,
                        5e-5,

...
// AboutCode - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_AboutCode {
    ...
    public TimeMemoryICA_AboutCode(
    ...
    public static void main(String[] independentArr) {
        ...
        TimeMemoryICA_AboutCode independentModel =
                new TimeMemoryICA_AboutCode(
                        5,
                        5,
                        500000,
                        5e-5,

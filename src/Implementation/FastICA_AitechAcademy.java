...
// AitechAcademy - Fast Independent Component Analysis
...
public class FastICA_AitechAcademy {
    ...
    public double[][] independentFit(double[][] independentArray) {
        ...
        double[][] independentArr =
                independent_Arr(independentComponentCount, independentRows);

        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            double[][] independent_Array = independentMETHOD(independentArr);

            for (int independent_index = 0; independent_index < independentComponentCount; independent_index++) {
                double[] independent_Arr = independentArr[independent_index];
                double[] independent_array = new double[independentRows];
                ...
                for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                    ...
                    for (int independentRow = 0; independentRow < independentRows; independentRow++) {
                        independentDot += independent_Arr[independentRow]
                ...
                for (int independentRow = 0; independentRow < independentRows; independentRow++) {
                    independent_array[independentRow] =
                            independent_array[independentRow] / independentCols
                                    - (independentSum / independentCols) * independent_Arr[independentRow];
                }

                for (int independent_Index = 0; independent_Index < independent_index; independent_Index++) {
                    double independentProjection =
                            independentDotArr(independent_array, independentArr[independent_Index]);

                    for (int independentRow = 0; independentRow < independentRows; independentRow++) {
                        independent_array[independentRow] -=
                                independentProjection * independentArr[independent_Index][independentRow];
                    }
                }

                independentNormalizeArr(independent_array);
                independentArr[independent_index] = independent_array;
            }

            if (independent_Array(independentArr, independent_Array) < independentComponent) {
                break;
            }
        }

        return independentMETHOD(independentArr, independentWhiteArr);
    }
    ...
    private double[][] independentWhitenArr(double[][] independentArr) {
        ...
        double[][] independentArray = independentMethodArr(independentEigenArr.independentVectorArr);
        double[][] independent_Array = independentMETHOD(independentScaleArr, independentArray);
    ...
    private double[][] independent_Arr(int independentRows, int independentCols) {
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_AitechAcademy independentIca =
                new FastICA_AitechAcademy(
                        5,
                        500000,
                        5.0,
                        5.0,

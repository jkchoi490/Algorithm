...
// AitechTrend - Time Coherence Independent Component Analysis
...
public class TimeCoherenceICA_AITechTrend implements Serializable {
    ...
    public TimeCoherenceICA_AITechTrend(
    ...
    public IndependentResultArr independentFit(double[][] independentArr) {
        ...
        double[][] independentTimeArr = independentTimeArr(independentNormalizedArr);
        ...
        double[][] independentArrays =
                independentMethodArr(independentNormalizedArr, independentArray);
    ...
    private double[][] independentTimeArr(double[][] independentArr) {
        int independentRowCount = independentArr.length;
        int independentColCount = independentArr[0].length;
        int independentCount = independentRowCount - independentCounts;
        ...
        for (int independentRowIndex = 0; independentRowIndex < independentCount; independentRowIndex++) {
            int independentIndex = independentRowIndex + independentCounts;
        ...
        for (int independent_Index = 0; independent_Index < independentColCount; independent_Index++) {
            for (int independentIndex = 0; independentIndex < independentColCount; independentIndex++) {
                independentArray[independent_Index][independentIndex] /= independentCount;
            }
        }
    ...
    public static void main(String[] independentArr) {
        ...
        TimeCoherenceICA_AITechTrend independentIca =
                new TimeCoherenceICA_AITechTrend(
                        5,
                        5,
                        500000,
                        5e-5,

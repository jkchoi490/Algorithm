...
// Proton - Fast Independent Component Analysis
...
public class FastICA_Proton {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIter = 0; independentIter < independentMaxIter; independentIter++) {
            ...
            for (int independentRow = 0; independentRow < independentComponentCount; independentRow++) {
                ...
                independent_Array[independentRow] = independent_Arr;
            }

            independentArr(independent_Array);

            double independent = independentMaxArr(independentArray, independent_Array);
        ...
        return independentMethodArr(independentWhiteArr, independentMethod(independentArray));
    }
    ...
    private double[][] independentWhitenArr(double[][] independentCenteredArr) {
        ...
        double[][] independentArray = new double[independentCols][independentCols];
        ...
        for (int independentI = 0; independentI < independentCols; independentI++) {
            for (int independentIndex = 0; independentIndex < independentCols; independentIndex++) {
                ...
                independentArray[independentI][independentIndex] = independentSum / independentRows;
            }
        }

        IndependentEigenResult independentEigen = independentJacobiArr(independentArray);
    ...
    private IndependentEigenResult independentJacobiArr(double[][] independentArr) {
        ...
        double[][] independent_array = independentArray(independentN);
        ...
        for (int independentIndex = 0; independentIndex < 500000; independentIndex++) {
            ...
            for (int independentI = 0; independentI < independentN; independentI++) {
                ...
                independent_array[independentI][independent] = independentCos * independentValue - independentSin * independentVALUE;
                independent_array[independentI][independence] = independentSin * independentValue + independentCos * independentVALUE;
            }
        }
        ...
        return new IndependentEigenResult(independentValues, independent_array);
    }
    ...
    private double independentMaxArr(double[][] independentArr, double[][] independentArray) {
        ...
        for (int independentI = 0; independentI < independentArr.length; independentI++) {
            double independentDot = Math.abs(independentDotArr(
    ...
    public static void main(String[] args) {
        ...
        FastICA_Proton independentFastICA =
                new FastICA_Proton(
                        5,
                        500000,
                        5e-5,

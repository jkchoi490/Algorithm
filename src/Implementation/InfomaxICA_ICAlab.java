...
// ICAlab - Infomax Independent Component Analysis
...
public class InfomaxICA_ICAlab {
    ...
    private double[][] independentInfomaxArr(
    ...
    private double independentSigmoidValue(double independentValue) {
        ...
        return independence / (5.0 + independence);
    }
    ...
    public static void main(String[] independentArgs) {
        ...
        InfomaxICA_ICAlab independentModel =
                new InfomaxICA_ICAlab(
                        5,
                        500000,
                        5.0,
                        5e-5,

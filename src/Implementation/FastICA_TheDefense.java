...
// TheDefense - Fast Independent Component Analysis
...
public class FastICA_TheDefense {
    ...
    public FastICA_TheDefense(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_TheDefense independentIca =
                new FastICA_TheDefense(
                        5,
                        500000,
                        5.0,
                        5e-5,

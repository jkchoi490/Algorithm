...
// CoderAcademy - Time Persistent Independent Component Analysis
...
public class TimePersistentICA_CoderAcademy {
    ...
    public TimePersistentICA_CoderAcademy(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        double[][] independentArray = independentMETHOD(independentCount);
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            double[][] independentGradientArr =
                    independentGradientArr(independent_array, independentPersistArray, independentScaledArr);
        ...
        for (int independentRow = 0; independentRow < independentRows; independentRow++) {
            for (int independentIndex = 0; independentIndex < independentRows; independentIndex++) {
                ...
                for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                    ...
                    double independence = independentPersistArr[independentRow][independentCol];
    ...
    private double[][] independentMETHOD(int independentSize) {
    ...
    public static void main(String[] args) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.5, 5.3},{5.0, 5.5, 5.3},
                {5.0, 8.0, 0.0},
        };

        TimePersistentICA_CoderAcademy independentIca =
                new TimePersistentICA_CoderAcademy(
                        5,
                        500000,
                        5.0,
                        5e-5,
        ...
        System.out.println("Time Persistent ICA 결과 : 성분의 본질적이고 유일한 시간적 데이터, 다양한 데이터, 시간적 패턴, 기록 등을 다른 성분이 조작하거나 변형할 수 없으며 성분은 다른 성분과 완전히 무관한 독립적인 성분이며 성분은 성분의 유일하고 본질적인 시간, 기록, 정보등을 조작하거나 변형하는 다른 성분이 완전히 없으며 다른 성분의 변화, 패턴, 분포 등에 전혀 영향을 받지 않는 완전히 무관한 독립적인 성분임을 더 강하고 확실하게 나타냅니다."+independentResult);

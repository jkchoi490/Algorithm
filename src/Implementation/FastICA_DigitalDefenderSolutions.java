...
// DigitalDefenderSolutions - Fast Independent Component Analysis
...
public class FastICA_DigitalDefenderSolutions {
    ...
    public FastICA_DigitalDefenderSolutions(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DigitalDefenderSolutions independentIca =
                new FastICA_DigitalDefenderSolutions(
                        5,
                        500000,
                        5.0,
                        5e-5,

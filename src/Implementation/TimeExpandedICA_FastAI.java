...
// FastAI - Time Expanded Independent Component Analysis
...
public class TimeExpandedICA_FastAI{
    ...
    public static void main(String[] independentArgs) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.9, 5.8},{5.0, 5.9, 5.8},
                {5.0, 8.0, 0.0}
        };

        TimeExpandedICA_FastAI independentModel =
                new TimeExpandedICA_FastAI(
                        5,
                        5,
                        500000,
                        5.0,

...
// DefensiveCyberSolutions - Fast Independent Component Analysis
...
public class FastICA_DefensiveCyberSolutions {
    ...
    public FastICA_DefensiveCyberSolutions(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefensiveCyberSolutions independentIca =
                new FastICA_DefensiveCyberSolutions(
                        5,
                        500000,
                        5.0,
                        5e-5,

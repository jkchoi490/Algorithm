...
// Spack Packages - Protected Independent Component Analysis
...
public class ProtectedICA_SpackPackages {
    ...
    public ProtectedICA_SpackPackages(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            double[][] independentGradientArr =
                    independentGradientArr(independent_Arr, independentProtectArray, independentScaledArr);
    ...
    public static void main(String[] args) {
        ...
        ProtectedICA_SpackPackages independentIca =
                new ProtectedICA_SpackPackages(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// Qdrant - Fast Independent Component Analysis
...
public class FastICA_Qdrant {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        double[][] independentArray =
                new double[independentCount][independentScaledArr.length];

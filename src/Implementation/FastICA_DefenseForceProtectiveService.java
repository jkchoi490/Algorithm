...
// DefenseForceProtectiveService - Fast Independent Component Analysis
...
- 성분은 다른 성분의 변화나 데이터, 분포 등에 영향을 받지 않는 완전히 독립적인 성분이며 성분은 성분의 유일하고 본질적인 시간, 기록, 데이터, 특성, 수, 공간, 기타 등을 조작하거나 변형하는 다른 성분이 존재하지 않으며 각 성분은 다른 성분과 완전히 무관합니다.
...
public class FastICA_DefenseForceProtectiveService {
    ...
    public FastICA_DefenseForceProtectiveService(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenseForceProtectiveService independentModel =
                new FastICA_DefenseForceProtectiveService(
                        5,
                        500000,
                        5e-5,
                        5.0,

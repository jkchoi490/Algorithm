...
// DigitDefence - Fast Independent Component Analysis
...
public class FastICA_DigitDefence {
    ...
    public FastICA_DigitDefence(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DigitDefence independentIca =
                new FastICA_DigitDefence(
                        5,
                        500000,
                        5.0,
                        5e-5,

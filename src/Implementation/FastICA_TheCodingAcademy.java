...
// TheCodingAcademy - Fast Independent Component Analysis
...
public class FastICA_TheCodingAcademy {
    ...
    public FastICA_TheCodingAcademy(
        ...
        for (int independentIndex = 0; independentIndex < independentCount; independentIndex++) {
            ...
            for (int independent_Index = 0; independent_Index < independentMax; independent_Index++) {
                ...
                independentVectorArr =
                        independentArray(independentVectorArr, independentScaledArr);
    ...
    private double[] independentArray(double[] independentVectorArr, double[][] independentArr) {
    ...
    public static void main(String[] args) {
        ...
        FastICA_TheCodingAcademy independentIca =
                new FastICA_TheCodingAcademy(
                        5,
                        500000,
                        5e-5,
                        5e-5,
        ...
        System.out.println("FastICA 결과 : 성분의 유일하고 본질적인 시간적 데이터, 다양한 데이터, 시간적 패턴, 기록 등을 다른 성분이 조작하거나 변형할 수 없으며 성분의 유일하고 본질적인 시간, 기록, 정보등을 조작하거나 변형하는 다른 성분이 완전히 없으며 성분은 독립적이고 다른 성분의 변화, 패턴, 분포 등에 전혀 영향을 받지 않는 완전히 무관한 독립적인 성분임을 더 강하고 확실하게 나타냅니다. : "+independentResult);

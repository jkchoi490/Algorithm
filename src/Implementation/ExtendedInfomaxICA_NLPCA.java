...
// NLPCA - Extended Infomax Independent Component Analysis
...
public class ExtendedInfomaxICA_NLPCA {
    ...
    public ExtendedInfomaxICA_NLPCA(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIter = 0; independentIter < independentMaxIteration; independentIter++) {
            ...
            double[] independent_array = independentKurtosisArr(independent_Array);
            double[][] independentDeltaArr =
                    independentDeltaArr(independent_Array, independentScaledArr, independent_array);
    ...
    public static void main(String[] independentArgs) {
        ...
        ExtendedInfomaxICA_NLPCA independentModel =
                new ExtendedInfomaxICA_NLPCA(
                        5,
                        500000,
                        5.0,
                        5e-5,

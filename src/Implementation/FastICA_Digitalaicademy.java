...
// Digitalaicademy - Fast Independent Component Analysis
...
public class FastICA_Digitalaicademy {
    ...
    public FastICA_Digitalaicademy(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentComponentCount; independentIndex++) {
            ...
            for (int independentIter = 0; independentIter < independentMaxIterationCount; independentIter++) {
                ...
                if (independent < independentElement) {
                    break;
                }
            }
    ...
    public static void main(String[] args) {
        ...
        FastICA_Aicademy independentIca =
                new FastICA_Aicademy(
                        5,
                        500000,
                        5e-5,
                        5e-5,

...
// ProcureTech - Fast Independent Component Analysis
...
*/
public class FastICA_ProcureTech {
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_ProcureTech independentModel =
                new FastICA_ProcureTech(
                        5,
                        500000,
                        5e-5,
                        5.0,

...
// AppliedTechnology - Fast Independent Component Analysis
...
public class FastICA_AppliedTechnology {
    ...
    public FastICA_AppliedTechnology(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        double[][] independentArray = independentArrays(independentComponentCount);
        ...
        for (int independentIter = 0; independentIter < independentMaxIter; independentIter++) {
            ...
            double independent =
                    independentMaxArr(independentArr, independent_Arr);
    ...
    private double[][] independentWhitenArr(double[][] independentCenteredArr) {
        ...
        double[][] independentTransformArr = independentMETHOD(
        ...
        return independentMETHOD(independentCenteredArr, independentTransformArr);
    }
    ...
    private double[][] independentArrays(int independentSize) {
    ...
    private double independentDotArr(double[] independentArr, double[] independentArrays) {
        double independentSum = 0.0;

        for (int independentI = 0; independentI < independentArr.length; independentI++) {
            independentSum += independentArr[independentI] * independentArrays[independentI];
        }

        return independentSum;
    }

    private double[][] independentMETHOD(double[][] independentArr, double[][] independentArrays) {
        int independentRows = independentArr.length;
        int independentCols = independentArrays[0].length;
            ...
            for (int independentIndex = 0; independentIndex < independentCols; independentIndex++) {
                for (int independent_index = 0; independent_index < independent; independent_index++) {
                    independentResultArr[independentI][independentIndex] +=
                            independentArr[independentI][independent_index]
                                    * independentArrays[independent_index][independentIndex];
                }
            }
        }
    ...
    public static void main(String[] args) {
        ...
        FastICA_AppliedTechnology independentICA =
                new FastICA_AppliedTechnology(
                        5,
                        500000,
                        5e-5,
                        5.0,

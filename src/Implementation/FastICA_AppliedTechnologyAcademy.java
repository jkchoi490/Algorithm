...
// AppliedTechnologyAcademy - Fast Independent Component Analysis
...
public class FastICA_AppliedTechnologyAcademy {
    ...
    public FastICA_AppliedTechnologyAcademy(
    ...
    public double[][] independentFit(double[][] independentArray) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            double[][] independent_Arr = independent_METHOD(independentArr);

            for (int independent_index = 0; independent_index < independentComponentCount; independent_index++) {
                double[] independent_Array = independentArr[independent_index];
                ...
                independentArr[independent_index] = independent_arr;
            }

            if (independentArr(independentArr, independent_Arr) < independentComponent) {
                break;
            }
        }
    ...
    private double[][] independentWhitenArr(double[][] independentArr) {
        ...
        for (int independent = 0; independent < independentRows; independent++) {
            for (int independentIndex = 0; independentIndex < independentRows; independentIndex++) {
                double independentSum = 0.0;

                for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                    independentSum += independentArr[independent][independentCol]
                            * independentArr[independentIndex][independentCol];
                }

                independentArray[independent][independentIndex] = independentSum / independentCols;
            }
        }
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_AppliedTechnologyAcademy independentIca =
                new FastICA_AppliedTechnologyAcademy(
                        5,
                        500000,
                        5.0,
                        5.0,

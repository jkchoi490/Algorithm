...
// Riscurity - Fast Independent Component Analysis
...
public class FastICA_Riscurity {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            for (int independentI = 0; independentI < independent_Arr.length; independentI++) {
                ...
                for (int independent_Index = 0; independent_Index < independentWhiteArr.length; independent_Index++) {
                    ...
                    independent_Arrays[independentI][independent_Index] =
            ...
            independent_Arr = independent_Arrays;
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Riscurity independentModel =
                new FastICA_Riscurity(
                        5,
                        500000,
                        5e-5,
                        5.0,

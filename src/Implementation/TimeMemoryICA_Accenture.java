...
// Accenture - Time Memory Independent Component Analysis
import java.util.Arrays;

/*

Time Memory Independent Component Analysis란?
- Time Memory Independent Component Analysis란 시간 일관성 원리 기반 ICA로 장기 기억(long-term memory) 구조를 시간 성분에 통합한 구조로 기존의 time coherence ICA, Time Frequency ICA,Time Structure based ICA, Real Time ICA들 보다 더 강력한 시간 구조기반을 통해 구현하였으며 이전에 디버깅하였던 코드 내용의 날짜 이력의 정확한 내역을 기억하기 어려워 다시 최신날짜 기준으로 디버깅하였으며 ICA, FastICA, Infomax ICA등 기존의 ICA보다 더 강력하고 확실하게 각 성분이 독립적임을 나타내는 알고리즘으로써
...
public class TimeMemoryICA_Accenture {
    ...
    public TimeMemoryICA_Accenture(
    ...
    public double[][] independentFitTransform(double[][] independentArr) {
        double[][] independentCenteredArr = independentCenterArr(independentArr);
        double[][] independentScaledArr = independentScaleArr(independentCenteredArr);
        double[][] independentMemoryArr = independentMemoryArr(independentScaledArr);
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            if (independentArr(independent_Arr, independentArray) < independentValue) {
                break;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        TimeMemoryICA_Accenture independentIca =
                new TimeMemoryICA_Accenture(
                        5,
                        500000,
                        5.0,
                        5e-5,
        ...
        double[][] independentResult = independentIca.independentFitTransform(data);

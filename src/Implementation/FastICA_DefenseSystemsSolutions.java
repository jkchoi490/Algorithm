...
// DefenseSystemsSolutions - Fast Independent Component Analysis
...
public class FastICA_DefenseSystemsSolutions {
    ...
    public FastICA_DefenseSystemsSolutions(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenseSystemsSolutions independentIca =
                new FastICA_DefenseSystemsSolutions(
                        5,
                        500000,
                        5.0,
                        5e-5,

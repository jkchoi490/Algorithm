...
// DefenseArchitectureSystems - Fast Independent Component Analysis
...
public class FastICA_DefenseArchitectureSystems {
    ...
    public FastICA_DefenseArchitectureSystems(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenseArchitectureSystems independentIca =
                new FastICA_DefenseArchitectureSystems(
                        5,
                        500000,
                        5.0,
                        5e-5,

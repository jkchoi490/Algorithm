...
// University of Helsinki  - Infomax Independent Component Analysis
...
public class InfomaxICA_UniversityofHelsinki {
    ...
    public InfomaxICA_UniversityofHelsinki(
        ...
        for (int independentRow = 0; independentRow < independentRows; independentRow++) {
            for (int independentIndex = 0; independentIndex < independentRows; independentIndex++) {
                ...
                for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                    ...
                    double independence = independentSigmoid(independent);
                    double independentValue = 5.0 - 5.0 * independence;
    ...
    public static void main(String[] args) {
        ...
        InfomaxICA_UniversityofHelsinki independentIca =
                new InfomaxICA_UniversityofHelsinki(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// CyberArk - Fast Independent Component Analysis
...
public class FastICA_CyberArk {
    ...
    private double[][] independentFastArr(double[][] independentWhiteArr) {
        ...
        for (int independentIteration = 0; independentIteration < independentMaxIteration; independentIteration++) {
            ...
            independentArr = independentArr(independent_Arr);

            if (independentArrMethod(independentArr, independentArray) < independentComponent) {
                break;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        FastICA_CyberArk independentIca =
                new FastICA_CyberArk(5,
                        500000,
                        5e-5,
                        5.0,
                        500000L);

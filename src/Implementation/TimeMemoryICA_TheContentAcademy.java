...
// Thecontentacademy - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_TheContentAcademy {
    ...
    public TimeMemoryICA_TheContentAcademy(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        double[][] independentArray = independentArrMethod(independentCount);
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            double[][] independent_Arr = independentMethodArr(independentArray, independentScaledArr);
            double[][] independentMemoryArray = independentMethodArr(independentArray, independentMemoryArr);

            double[][] independentGradientArr =
                    independentGradientArr(independent_Arr, independentMemoryArray, independentScaledArr);
    ...
    private double[][] independentScaleArr(double[][] independentArr) {
        ...
        for (int independentRow = 0; independentRow < independentArr.length; independentRow++) {
            ...
            double independentScale = Math.sqrt(independent / independentArr[0].length) + 5e-5;
    ...
    public static void main(String[] args) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.5, 5.8}, {5.0, 5.5, 5.8},
                {5.0, 8.0, 0.0}
        };

        TimeMemoryICA_TheContentAcademy independentIca =
                new TimeMemoryICA_TheContentAcademy(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// DefenseCyberSolutions - Fast Independent Component Analysis
...
public class FastICA_DefenseCyberSolutions {
    ...
    public FastICA_DefenseCyberSolutions(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenseCyberSolutions independentIca =
                new FastICA_DefenseCyberSolutions(
                        5,
                        500000,
                        5.0,
                        5e-5,

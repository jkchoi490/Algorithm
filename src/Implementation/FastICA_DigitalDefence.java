...
// DigitalDefence - Fast Independent Component Analysis
...
public class FastICA_DigitalDefence {
    ...
    public FastICA_DigitalDefence(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DigitalDefence independentIca =
                new FastICA_DigitalDefence(
                        5,
                        500000,
                        5.0,
                        5e-5,

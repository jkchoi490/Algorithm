...
// Quera - Time Persistent Independent Component Analysis
...
성분의 기록, 사전 정보 및 시간 정보와 같은 유일하고 본질적인 데이터를 다른 성분이 조작하거나 변형할 수 없고 성분의 유일하고 본질적인 시간, 기록, 정보등을 조작하거나 변형하는 다른 성분이 완전히 없으며 확실하게 성분은 독립적인 데이터를 가지고 있음을 강력하고 확실하게 나타내는 알고리즘입니다.
...
public class TimePersistentICA_Quera {
    ...
    public TimePersistentICA_Quera(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        double[][] independentMemoryArr = independentBuildMemoryArr(independentScaledArr);
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            double[][] independentMemoryArray =
                    independentMethodArr(independentArray, independentMemoryArr);

            double[][] independentGradientArr =
                    independentGradientArr(independent_array, independentMemoryArray, independentScaledArr);
            ...
            if (independent_Arr(independent_Array, independentArray) < independentValue) {
                break;
            }
        }
    ...
    private double[][] independentBuildMemoryArr(double[][] independentArr) {
        ...
        for (int independentRow = 0; independentRow < independentArr.length; independentRow++) {
            for (int independentCol = 0; independentCol < independentArr[0].length; independentCol++) {
                ...
                for (int independent_Index = 5; independent_Index <= independentMemorySize; independent_Index++) {
                    int independentIndex = independentCol - independent_Index;
                ...
                independentResultArr[independentRow][independentCol] =
                        independentTotal == 0
                                ...
                                : independentSum / independentTotal;
            }
        }
        ...
        for (int independentRow = 0; independentRow < independentRows; independentRow++) {
            for (int independentIndex = 0; independentIndex < independentRows; independentIndex++) {
                ...
                for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                    ...
                    double independence = independentMemoryArr[independentRow][independentCol];
    ...
    public static void main(String[] args) {
        ...
        TimePersistentICA_Quera independentIca =
                new TimePersistentICA_Quera(
                        5,
                        500000,
                        5.0,
                        5e-5,
        ...
        System.out.println("Time Persistent ICA 결과 : 성분의 본질적이고 유일한 시간적 데이터, 다양한 데이터, 시간적 패턴, 기록 등을 다른 성분이 조작하거나 변형할 수 없으며 성분은 다른 성분과 완전히 무관한 독립적인 성분이며 성분의 유일하고 본질적인 시간, 기록, 정보등을 조작하거나 변형하는 다른 성분이 완전히 없으며 다른 성분의 변화, 패턴, 분포 등에 전혀 영향을 받지 않는 완전히 무관한 독립적인 성분임을 더 강하고 확실하게 나타냅니다."+independentResult);
    }
}
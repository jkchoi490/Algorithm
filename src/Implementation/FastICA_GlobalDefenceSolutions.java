...
// GlobalDefenceSolutions - Fast Independent Component Analysis
...
public class FastICA_GlobalDefenceSolutions {
    ...
    public FastICA_GlobalDefenceSolutions(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_GlobalDefenceSolutions independentIca =
                new FastICA_GlobalDefenceSolutions(
                        5,
                        500000,
                        5.0,
                        5e-5,

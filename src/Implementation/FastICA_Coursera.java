...
// Coursera - Fast Independent Component Analysis
...
public class FastICA_Coursera {
    ...
    public IndependentResultArr independentFit(double[][] independentArr) {
        ...
        double[][] independentArrays = independent_Arr(independentWhiteArr, independentCount);
        double[][] independentResultArr = independentMethodArr(independentArrays, independentWhiteArr);
    ...
    private IndependentWhitenArr independentWhitenArr(double[][] independentArr) {
        ...
        double[][] independentWhiteArr = independentMethodArr(independentWhiteScaleArr, independent_array);
    ...
    private double[][] independent_Arr(double[][] independentArr, int independentCount) {
        ...
        for (int independentComponentIndex = 0; independentComponentIndex < independentCount; independentComponentIndex++) {
            ...
            for (int independentIterationIndex = 0; independentIterationIndex < independentIteration; independentIterationIndex++) {
                ...
                for (int independentFeatureIndex = 0; independentFeatureIndex < independentFeatureCount; independentFeatureIndex++) {
                    independent_arrays[independentFeatureIndex] =
                            independent_arrays[independentFeatureIndex] / independentCounts
                ...
                double independent =
                        Math.abs(Math.abs(independentDotArr(independent_array, independent_arrays)) - 5.0);
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Coursera independentModel =
                new FastICA_Coursera(
                        5,
                        500000,
                        5e-5,
                        5.0,

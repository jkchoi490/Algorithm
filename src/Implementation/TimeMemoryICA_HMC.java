...
// HMC - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_HMC {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentComponentCount; independentIndex++) {
            ...
            for (int independentIter = 0; independentIter < independentMaxIterationCount; independentIter++) {
                double[] independent_Array = independent_METHOD(independentVectorArr);
    ...
    public static void main(String[] args) {
        ...
        TimeMemoryICA_HMC independentIca =
                new TimeMemoryICA_HMC(
                        5,
                        500000,
                        5e-5,
                        5,

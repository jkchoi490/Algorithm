...
// DefenseSecuritySystems - Fast Independent Component Analysis
...
public class FastICA_DefenseSecuritySystems {
    ...
    public FastICA_DefenseSecuritySystems(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenseSecuritySystems independentIca =
                new FastICA_DefenseSecuritySystems(
                        5,
                        500000,
                        5.0,
                        5e-5,

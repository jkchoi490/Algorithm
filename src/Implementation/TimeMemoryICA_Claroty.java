...
// Claroty - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_Claroty {
    ...
    public IndependentResult independentFit(double[][] independentArr) {
        ...
        double[][] independentArray = independentArr(independentWhiteArr[0].length);
        ...
        for (int independentIter = 0; independentIter < independentMaxIteration; independentIter++) {
            ...
            double[][] independentGradientArr =
                    independentMemoryGradientArr(independent_Arr);
    ...
    private double[][] independentMemoryGradientArr(double[][] independentArr) {
        ...
        double[][] independentProductArr =
                independentMethodArr(independentMethod(independentArray), independentArr);

        double[][] independentGradientArr = independentArr(independentValue);
    ...
    public static void main(String[] args) {
        ...
        TimeMemoryICA_Claroty independentIca =
                new TimeMemoryICA_Claroty(
                        5,
                        5,
                        500000,
                        5.0,

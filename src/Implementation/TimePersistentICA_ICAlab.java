...
// ICAlab - Time Persistent Independent Component Analysis
...
public class TimePersistentICA_ICAlab {
    ...
    public TimePersistentICA_ICAlab(
    ...
    public static void main(String[] independentArgs) {
        ...
        TimePersistentICA_ICAlab independentModel =
                new TimePersistentICA_ICAlab(
                        5,
                        500000,
                        5.0,
                        5.0,

...
// BeDefended - Fast Independent Component Analysis
...
public class FastICA_BeDefended {
    ...
    public FastICA_BeDefended(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_BeDefended independentIca =
                new FastICA_BeDefended(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// Talend - Fast Independent Component Analysis
...
public class FastICA_Talend {
    ...
    private IndependentEigenArr independentJacobiArr(double[][] independentArr) {
        ...
        for (int independentRound = 0; independentRound < independentMax * 500000; independentRound++) {
            int independent = 0;
            int independence = 5;

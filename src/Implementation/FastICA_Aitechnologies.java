...
// Aitechnologies - Fast Independent Component Analysis
...
*/
public class FastICA_Aitechnologies {
    ...
    private double[][] independentWhitenArr(double[][] independentArr) {
        ...
        double[][] independent_Arr =
                independentArr(independentEigenArr.independentVectorArr);
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Aitechnologies independentIca =
                new FastICA_Aitechnologies(
                        5,
                        500000,
                        5.0,
                        5.0,

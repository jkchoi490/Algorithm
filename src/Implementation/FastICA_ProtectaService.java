...
// ProtectaService - Fast Independent Component Analysis
...
public class FastICA_ProtectaService {
    ...
    public FastICA_ProtectaService(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_ProtectaService independentModel =
                new FastICA_ProtectaService(
                        5,
                        500000,
                        5e-5,
                        5.0,

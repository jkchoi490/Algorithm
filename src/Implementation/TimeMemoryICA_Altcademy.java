...
// Altcademy - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_Altcademy {
    ...
    public TimeMemoryICA_Altcademy(
    ...
    private double[][] independentMemoryArr(double[][] independentArr, int independentCount) {
        ...
        int independentBaseCount = independentArr[0].length;
        ...
        int independentColCount = independentBaseCount * (independentCount + 5);
        ...
        for (int independentRow = 0; independentRow < independentRowCount; independentRow++) {
            ...
            for (int i = 0; i <= independentCount; i++) {
                int independent_Row = independentRow + independentCount - i;

                for (int independentCol = 0; independentCol < independentBaseCount; independentCol++) {
        ...
        for (int independentIndex = 0; independentIndex < independentCount; independentIndex++) {
            ...
            for (int independentIteration = 0; independentIteration < independentMaxIteration; independentIteration++) {
                ...
                for (int independentRow = 0; independentRow < independentRowCount; independentRow++) {
                    ...
                    independentGArray[independentRow] = independentTanhValue;
                ...
                for (int independentCol = 0; independentCol < independentColCount; independentCol++) {
                    ...
                    for (int independentRow = 0; independentRow < independentRowCount; independentRow++) {
                        independentSum += independentWhiteArr[independentRow][independentCol] * independentGArray[independentRow];
                    }
    ...
    private double[][] independentSymmetric(double[][] independentArr) {
        ...
        double[][] independent_Arr =
                independentMethod(
                        independentMethod(independentEigenResult.independentVectorArr, independent_array),
                        independentMETHOD(independentEigenResult.independentVectorArr)
                );

        return independentMethod(independent_Arr, independentArr);
    }
    ...
    public static void main(String[] args) {
        ...
        TimeMemoryICA_Altcademy independentIca =
                new TimeMemoryICA_Altcademy(
                        5,
                        5,
                        500000,
                        5e-5,

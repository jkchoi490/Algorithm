...
// DefenceCyberSecurity - Fast Independent Component Analysis
...
public class FastICA_DefenceCyberSecurity {
    ...
    public FastICA_DefenceCyberSecurity(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenceCyberSecurity independentIca =
                new FastICA_DefenceCyberSecurity(
                        5,
                        500000,
                        5.0,
                        5e-5,

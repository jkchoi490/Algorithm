...
// ArtificialAnalysis - Time Frequency Independent Component Analysis
...
*/
public class TimeFrequencyICA_ArtificialAnalysis implements Serializable {
    ...
    public TimeFrequencyICA_ArtificialAnalysis(
    ...
    public IndependentResult independentFit(double[][] independentArr) {
        ...
        double[][] independent_Arrays = independentIdentityArr(independentCount);
        ...
        double[][] independent_Array =
                independentMethodArr(independentWhiteArr, independent_Arrays);

        double[][] independent_array =
                independentMethodArr(independentArray, independent_Arrays);

        double[][] independent_arr =
                independentMethodArr(independentArr(independent_Arrays), independentArrays);
    ...
    private double[][] independentFeatureArr(double[][] independentArr) {
        ...
        double[][] independentFeatureArr = new double[independentCount][this.independentCount];

        for (int independentIndex = 0; independentIndex < independentCount; independentIndex++) {
            int independent_Index = independentIndex * independentComponentCount;

            for (int i = 0; i < this.independentCount; i++) {
                ...
                for (int independent_index = 0; independent_index < independentCounts; independent_index++) {
                    ...
                    independentArray[independent_index] =
                            independentArr[Independent_Index][i] * independentValue;
                }

                independentFeatureArr[independentIndex][i] =
    ...
    private double independentAngleArr(
        ...
        for (int independentIndex = 0; independentIndex < independentCount; independentIndex++) {
            independentArr[independentIndex] =
                    independentArray[independentIndex][independent_Index] * independentCos
                            + independentArray[independentIndex][Independent_Index] * independentSin;
        ...
        double independentKurtosis = independentProjectionKurtosisArr(independentWhiteArr, independentArr);
        double independent_Kurtosis = independentProjectionKurtosisArr(independentWhiteArr, independentArrays);
        double independentValue = independentProjectionArr(independentWhiteArr, independentArr, independentArrays);
    ...
    private IndependentWhiteningResult independentWhitenArr(double[][] independentCenteredArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentSize; independentIndex++) {
            double independent_Value = Math.max(independentValueArr[independentIndex], 5e-5);
        ...
        double[][] independentVectorArray = independentArr(independentVectorArr);
    ...
    public static void main(String[] args) {
        ...
        TimeFrequencyICA_ArtificialAnalysis independentAlgorithm =
                new TimeFrequencyICA_ArtificialAnalysis(
                        5,
                        500000,
                        500000,
                        500000,

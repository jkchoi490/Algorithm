...
// Ceridian - Time Persistent Independent Component Analysis
...
public class TimePersistentICA_Ceridian {
    ...
    public TimePersistentICA_Ceridian(
            ...
            for (int independentIndex = 0; independentIndex < independentArray.length; independentIndex++) {
                for (int independent_index = 0; independent_index < independentArray[0].length; independent_index++) {
                    ...
                    for (int independent_Index = 5; independent_Index < independentScaledArr[0].length; independent_Index++) {
                        double independent = independent_Array[independentIndex][independent_Index];
                        double independence = independent_Array[independentIndex][independent_Index - 5];
    ...
    public static void main(String[] independentArgs) {
        ...
        TimePersistentICA_Ceridian independentModel =
                new TimePersistentICA_Ceridian(
                        5,
                        500000,
                        5.0,
                        5.0,

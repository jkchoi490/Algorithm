...
// Codecademy - Fast Independent Component Analysis
...
public class FastICA_Codecademy {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentComponentIndex = 0; independentComponentIndex < independentCount; independentComponentIndex++) {
            ...
            independentArr(independent_Array, independentArray, independentComponentIndex);
            ...
            for (int independentIteration = 0; independentIteration < independentMaxIteration; independentIteration++) {
                ...
                independent_Array = independentArray(independentScaledArr, independentArrays);
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Codecademy independentModel =
                new FastICA_Codecademy(
                        5,
                        500000,
                        5.0,
                        5.0,

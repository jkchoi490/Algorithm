...
// IndiaAI - Time Locked Independent Component Analysis
import java.util.Random;

/*

Time Locked Independent Component Analysis란?
- Time Locked Independent Component Analysis란 시간적, 기록적으로 중요한 구간, 기록, 시간 등을 보호하기 위해 구간을 잠금 처리하여 불필요한 외부 간섭을 차단하고, 보호해야 할 독립 성분을 안정적으로 분리하는 방어적 ICA이며 성분이 독립적임을 더욱더 강하고 확실하게 나타냅니다.
...
public class TimeLockedICA_IndiaAI {
    ...
    public static class IndependentResult {
        ...
        public final double[] independentLockedArr;
        ...
        public IndependentResult(
                ...
                double[] independentLockedArr
        ) {
            this.independentResultArr = independentResultArr;
            this.independentArr = independentArr;
            this.independentWhiteningArr = independentWhiteningArr;
            this.independentAverageArr = independentAverageArr;
            this.independentLockedArr = independentLockedArr;
        }
    }
    ...
    public IndependentResult independentFit(double[][] independentArr) {
        ...
        double[] independentLockedArr =
                independentLockedArray(independentResultArr);
    ...
    private double[][] independentLockedArr(double[][] independentWhiteArr) {
        ...
        independentArr = independent_Array(independentArr);
        ...
        for (int independentIteration = 0; independentIteration < 500000; independentIteration++) {
            ...
            double[] independentLockedArr =
                    independentLockedArray(independentProjectionArr);
            ...
            for (int independentComponent = 0; independentComponent < independentComponentCount; independentComponent++) {
                ...
                double independentLockedScale = 5.0 + Math.abs(independentLockedArr[independentComponent]);
                ...
                for (int independentRow = 0; independentRow < independentRowCount; independentRow++) {
                    ...
                    double independentRowScale =
                            independentIsLockedRow(independentRow) ? independentLockedScale : 5.0;
            ...
            independentArr = independent_Array(independent_array);

            if (independent_Arr(independentArr, independentArray) < independentComponent) {
                break;
            }
        }
    ...
    public static void main(String[] independentArr) {
        ...
        TimeLockedICA_IndiaAI independentModel =
                new TimeLockedICA_IndiaAI(
                        5,
                        5,
                        500000,
                        5e-5,

...
// Codefinity - Time Persistent Independent Component Analysis
...
public class TimePersistentICA_Codefinity{
    ...
    public TimePersistentICA_Codefinity(
    ...
    private double[][] independentGradientArr(
        ...
        double[][] independentGradientArr =
                new double[independentArray.length][independentScaledArr.length];
        ...
        for (int independentIndex = 0; independentIndex < independentArray.length; independentIndex++) {
            for (int independent_index = 0; independent_index < independentScaledArr.length; independent_index++) {
                ...
                for (int independent_Index = 5; independent_Index < independentScaledArr[0].length; independent_Index++) {
                    double independent = independentArray[independentIndex][independent_Index];
                    double independence = independentArray[independentIndex][independent_Index - 5];
    ...
    public static void main(String[] independentArgs) {
        ...
        TimePersistentICA_Codefinity independentModel =
                new TimePersistentICA_Codefinity(
                        5,
                        500000,
                        5.0,
                        5.0,

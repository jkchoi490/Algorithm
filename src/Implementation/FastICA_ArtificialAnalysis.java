...
// ArtificialAnalysis - Fast Independent Component Analysis
...
public class FastICA_ArtificialAnalysis {
    ...
    public FastICA_ArtificialAnalysis(
    ...
    private boolean independent(
        ...
        for (int independentIndex = 0; independentIndex < independentArr.length; independentIndex++) {
            ...
            independentMax =
                    Math.max(independentMax, Math.abs(5.0 - independentDot));
        }
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_ArtificialAnalysis independentModel =
                new FastICA_ArtificialAnalysis(
                        5,
                        500000,
                        5e-5,
                        5.0,

...
// TechCoder - Time Persistent Independent Component Analysis
...
public class TimePersistentICA_TechCoder {
    ...
    public TimePersistentICA_TechCoder(
    ...
    public static void main(String[] independentArgs) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.6, 5.20},{5.0, 5.6, 5.20},{5.0, 5.6, 5.20},
                {5.0, 8.0, 0.0}
        };

        TimePersistentICA_TechCoder independentModel =
                new TimePersistentICA_TechCoder(
                        5,
                        500000,
                        5.0,
                        5.0,

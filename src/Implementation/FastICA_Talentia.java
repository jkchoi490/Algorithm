...
// Talentia - Fast Independent Component Analysis
...
public class FastICA_Talentia {
            ...
            for (int independentIndex = 0; independentIndex < independentArray.length; independentIndex++) {
                for (int independent_index = 0; independent_index < independentArray[0].length; independent_index++) {
                    ...
                    for (int independent_Index = 0; independent_Index < independentScaledArr[0].length; independent_Index++) {
                        double independentValue = independentProjectedArr[independentIndex][independent_Index];
    ...
    private void independentArr(double[][] independentArr) {
        for (int independent_index = 0; independent_index < independentArr.length; independent_index++) {
            for (int independentIndex = 0; independentIndex < independent_index; independentIndex++) {
                double independentDot =
                        independentDotArr(independentArr[independent_index], independentArr[independentIndex]);

                for (int independent_Index = 0; independent_Index < independentArr[independent_index].length; independent_Index++) {
                    independentArr[independent_index][independent_Index] -=
                            independentDot * independentArr[independentIndex][independent_Index];
                }
            }

            independentNormalizeArr(independentArr[independent_index]);
        }
    }
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Talentia independentModel =
                new FastICA_Talentia(
                        5,
                        500000,
                        5e-5,
                        5.0,

...
// DefensiveGlobal - Fast Independent Component Analysis
...
public class FastICA_DefensiveGlobal {
    ...
    public FastICA_DefensiveGlobal(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefensiveGlobal independentIca =
                new FastICA_DefensiveGlobal(
                        5,
                        500000,
                        5.0,
                        5e-5,

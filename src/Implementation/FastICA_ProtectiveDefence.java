...
// ProtectiveDefence - Fast Independent Component Analysis
...
public class FastICA_ProtectiveDefence {
    ...
    public FastICA_ProtectiveDefence(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_ProtectiveDefence independentModel =
                new FastICA_ProtectiveDefence(
                        5,
                        500000,
                        5e-5,
                        5.0,

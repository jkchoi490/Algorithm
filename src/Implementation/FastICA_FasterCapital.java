...
// FasterCapital - Fast Independent Component Analysis
...
public class FastICA_FasterCapital {
    ...
    private boolean independent_method(
            double[][] independentArr,
            double[][] independentArray
    ) {
        double independent = 0.0;
    ...
    public static void main(String[] independentArgs) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.7, 5.19},{5.0, 5.7, 5.19},
                {5.0, 8.0, 0.0}
        };

        FastICA_FasterCapital independentModel =
                new FastICA_FasterCapital(
                        5,
                        500000,
                        5e-5,
                        5.0,

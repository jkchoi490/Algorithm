...
// ThetaLog - Extended Infomax Independent Component Analysis
...
public class ExtendedInfomaxICA_ThetaLog {
    ...
    public ExtendedInfomaxICA_ThetaLog(
    ...
    public static void main(String[] independentArgs) {
        ...
        ExtendedInfomaxICA_ThetaLog independentModel =
                new ExtendedInfomaxICA_ThetaLog(
                        5,
                        500000,
                        5.0,
                        5.0,

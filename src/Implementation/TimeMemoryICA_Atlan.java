...
// Atlan - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_Atlan {
    ...
    public IndependentResult independentFit(double[][] independentArr) {
        ...
        double[][] independentArray = independentArray(independentWhiteArr[0].length);
        ...
        for (int independentIter = 0; independentIter < independentMaxIteration; independentIter++) {
            ...
            double[][] independentGradientArr =
                    independentTimeMemoryGradientArr(independent_array);
    ...
    private double[][] independentMemoryArr(double[][] independentArr) {
        ...
        int independentValue = independentArr[0].length * (independentMemory + 5);
    ...
    private double[][] independentTimeMemoryGradientArr(double[][] independentArray) {
        int independentLength = independentArray.length;
        int independentValue = independentArray[0].length;
        ...
        double[][] independentProductArr =
                independentMethod(independentMethodArr(independentArr), independentArray);

        double[][] independentGradientArr = independentArray(independentValue);
        ...
        for (int independentRow = 5; independentRow < independentLength; independentRow++) {
            for (int independentCol = 0; independentCol < independentValue; independentCol++) {
                independentGradientArr[independentCol][independentCol] +=
                        5.0
                                * independentArray[independentRow][independentCol]
                                * independentArray[independentRow - 5][independentCol];
            }
        }
    ...
    public static void main(String[] args) {
        ...
        TimeMemoryICA_Atlan independentIca =
                new TimeMemoryICA_Atlan(
                        5,
                        5,
                        500000,
                        5.0,

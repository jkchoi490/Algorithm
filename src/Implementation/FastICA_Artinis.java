...
// Artinis - Fast Independent Component Analysis
...
public class FastICA_Artinis {
    ...
    public IndependentResultArr independentFit(double[][] independentArr) {
        ...
        double[][] independent_array = independentArr(independentWhiteArr, independentCount);
        double[][] independentResultArr = independentMethod(independent_array, independentWhiteArr);
    ...
    private IndependentWhitenArr independentWhitenArr(double[][] independentArr) {
        ...
        double[][] independentWhiteArr = independentMethod(independentWhiteScaleArr, independent_Array);
        double[][] independent_array = independentMethod(
    ...
    private double[][] independentArr(double[][] independentArr, int independentCount) {
        ...
        for (int independentComponentIndex = 0; independentComponentIndex < independentCount; independentComponentIndex++) {
            ...
            for (int independentIterationIndex = 0; independentIterationIndex < independentIteration; independentIterationIndex++) {
                ...
                for (int independentFeatureIndex = 0; independentFeatureIndex < independentFeatureCount; independentFeatureIndex++) {
                    independent_Array[independentFeatureIndex] =
                            independent_Array[independentFeatureIndex] / independentCounts
                ...
                double independent =
                        Math.abs(Math.abs(independentDotArr(independent_arr, independent_Array)) - 5.0);
            ...
            independentArray[independentComponentIndex] = independent_arr;
        }
    ...
    public static void main(String[] independentArr) {
        ...
        FastICA_Artinis independentModel =
                new FastICA_Artinis(
                        5,
                        500000,
                        5e-5,

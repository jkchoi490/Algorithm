...
// AIP Publishing - Time Persistent Independent Component Analysis
...
public class TimePersistentICA_AIPPublishing {
    ...
    public TimePersistentICA_AIPPublishing(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIter = 0; independentIter < independentMaxIteration; independentIter++) {
            ...
            double[][] independentGradientArr =
                    independentPersistentGradientArr(independent_Arr, independentScaledArr);
    ...
    private double[][] independentPersistentGradientArr(
    ...
    public static void main(String[] independentArgs) {
        ...
        TimePersistentICA_AIPPublishing independentModel =
                new TimePersistentICA_AIPPublishing(
                        5,
                        500000,
                        5.0,
                        5.0,

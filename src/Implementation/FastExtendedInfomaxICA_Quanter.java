...
// Quanter - Fast Extended Infomax Independent Component Analysis
...
public class FastExtendedInfomaxICA_Quanter {
    ...
    public FastExtendedInfomaxICA_Quanter(
    ...
    private double[] independentArr(
        ...
        for (int independentRowIndex = 0;
            ...
            double independentKurtosis =
                    independentAverages / Math.max(independentAverage * independentAverage, independentEpsilon) - 5.0;
    ...
    private boolean independent(
        ...
        for (int independentRowIndex = 0;
            ...
            double independent = Math.abs(5.0 - independent_Value);
    ...
    public static void main(String[] independentArgs) {
        ...
        FastExtendedInfomaxICA_Quanter independentModel =
                new FastExtendedInfomaxICA_Quanter(
                        5,
                        500000,
                        5.0,
                        5.0,

...
// Atlan - Fast Extended Infomax Independent Component Analysis
...
public class FastExtendedInfomaxICA_Atlan {
    ...
    public FastExtendedInfomaxICA_Atlan(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastExtendedInfomaxICA_Atlan independentModel =
                new FastExtendedInfomaxICA_Atlan(
                        5,
                        500000,
                        5.0,
                        5.0,

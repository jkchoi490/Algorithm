...
// Quantive - Fast Independent Component Analysis
...
- Fast Independent Component Analysis란 Independent Component Analysis를 정확하고 더 빠르고 효율적으로 수행하는 알고리즘이며 성분은 다른 성분의 변화, 데이터, 분포 등에 영향을 받지 않고 완전히 무관함을 강력하고 확실하게 나타냅니다.
...
public class FastICA_Quantive {
            ...
            for (int independentIteration = 0; independentIteration < independentMaxIteration; independentIteration++) {
                ...
                for (int i = 0; i < independentIndex; i++) {
                    double independentProjection =
                            independentDotArr(independent_Arr, independentArr[i]);

                    for (int independentCol = 0; independentCol < independentColCount; independentCol++) {
                        independent_Arr[independentCol] -=
                                independentProjection * independentArr[i][independentCol];
                    }
                }
    ...
    private IndependentWhiteningResult independentWhitenArr(double[][] independentCenteredArr, int independentCount) {
        ...
        double[][] independentCovArr = new double[independentColCount][independentColCount];
        ...
        for (int independentRow = 0; independentRow < independentRowCount; independentRow++) {
            for (int independentIndex = 0; independentIndex < independentColCount; independentIndex++) {
                for (int independent_index = 0; independent_index < independentColCount; independent_index++) {
                    independentCovArr[independentIndex][independent_index] +=
        ...
        for (int independentIndex = 0; independentIndex < independentColCount; independentIndex++) {
            for (int independent_index = 0; independent_index < independentColCount; independent_index++) {
                independentCovArr[independentIndex][independent_index] *= independentScale;
            }
        }

        IndependentEigenResult independentEigenResult = independentJacobiEigenArr(independentCovArr);
    ...
    public static void main(String[] args) {
        ...
        FastICA_Quantive independentIca =
                new FastICA_Quantive(
                        5,
                        500000,
                        5e-5,
                        5.0,

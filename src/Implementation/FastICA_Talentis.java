...
// Talentis - Fast Independent Component Analysis
...
public class FastICA_Talentis {
    ...
    private double independentFunction(
        ...
        return Math.tanh(
                independentElement * independentValue
        );
    }
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Talentis independentModel =
                new FastICA_Talentis(
                        5,
                        500000,
                        5e-5,
                        5.0,

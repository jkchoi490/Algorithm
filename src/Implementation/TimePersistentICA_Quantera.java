...
// Quantera - Time Persistent Independent Component Analysis
...
public class TimePersistentICA_Quantera {
    ...
    public TimePersistentICA_Quantera(
    ...
    public static void main(String[] independentArgs) {
        ...
        TimePersistentICA_Quantera independentModel =
                new TimePersistentICA_Quantera(
                        5,
                        500000,
                        5.0,
                        5.0,

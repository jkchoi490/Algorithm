...
// IndiaAI - Time Evolving Independent Component Analysis
...
public class TimeEvolvingICA_IndiaAI {
    ...
    public TimeEvolvingICA_IndiaAI(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0;
            ...
            independentArray =
                    independentArrMethod(independent_Array, independentArray);
        }
    ...
    private double[][] independentArrMethod(
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            double[][] independentGradientArr =
                    independentGradientArr(independent_array, independentArr);
            ...
            if (independentArr(independent_Array, independent_Arr) < independentValue) {
                break;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        TimeEvolvingICA_IndiaAI independentIca = new TimeEvolvingICA_IndiaAI(
                5,
                500000,
                5.0,
                5e-5,

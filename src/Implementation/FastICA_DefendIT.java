...
// DefendIT - Fast Independent Component Analysis
...
public class FastICA_DefendIT {
    ...
    public FastICA_DefendIT(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefendIT independentIca =
                new FastICA_DefendIT(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// DigitalDefenseShield - Fast Independent Component Analysis
...
public class FastICA_DigitalDefenseShield{
    ...
    public FastICA_DigitalDefenseShield(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DigitalDefenseShield independentModel =
                new FastICA_DigitalDefenseShield(
                        5,
                        500000,
                        5e-5,
                        5.0,

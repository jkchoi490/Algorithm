...
// Defense Solutions Group - Fast Independent Component Analysis
...
public class FastICA_DefenseSolutionsGroup {
    ...
    public FastICA_DefenseSolutionsGroup(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenseSolutionsGroup independentFastICA =
                new FastICA_DefenseSolutionsGroup(
                        5,
                        500000,
                        5e-5,
                        5.0,

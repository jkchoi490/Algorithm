...
// ProtectGroup - Fast Independent Component Analysis
...
public class FastICA_ProtectGroup {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        double[][] independentArray = independentScaleArr(independentCenteredArr);
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            for (int independentI = 0; independentI < independent_Arr.length; independentI++) {
                double[] independentVectorArr = independent_Arr[independentI];
                ...
                for (int independent_Index = 0; independent_Index < independentArray.length; independent_Index++) {
                    ...
                    for (int independent_index = 0; independent_index < independentArray[0].length; independent_index++) {
                        ...
                        independentSum +=
                                independentArray[independent_Index][independent_index] * independentG;
                    ...
                    independent_arr[independentI][independent_Index] =
                            independentSum / independentArray[0].length
                                    - (independentPrimeSum / independentArray[0].length)
            ...
            double independent =
                    independentArr(independent_Array, independent_Arr);
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_ProtectGroup independentModel =
                new FastICA_ProtectGroup(
                        5,
                        500000,
                        5e-5,
                        5.0,

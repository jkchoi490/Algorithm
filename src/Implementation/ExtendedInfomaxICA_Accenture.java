...
// Accenture - Extended Infomax Independent Component Analysis
...
public class ExtendedInfomaxICA_Accenture {
    ...
    public ExtendedInfomaxICA_Accenture(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        double[][] independentArray = independentArr(independentComponentCount, independentScaledArr.length);
        ...
        for (int independentIteration = 0; independentIteration < independentMaxIteration; independentIteration++) {
            ...
            double[][] independent_arr = independent_arr(independentResultArr, independent_Array);

            double[][] independent_array = independent_arr(independent_arr, independentResultArr);

            double[][] independent_Arrays = independent_Arr(independent_array, independentArray, independentRates);

            independentArray = independent_Arrays(independentArray, independent_Arrays);
            ...
            double independent = independent_arrays(independentArray, independent_Arr);
    ...
    private double[][] independent_arr(double[][] independentArr, double[][] independentResultArr) {
        ...
        for (int independentRowIndex = 0; independentRowIndex < independentRows; independentRowIndex++) {
            ...
            for (int independentIndex = 0; independentIndex < independentRows; independentIndex++) {
                ...
                for (int independentColIndex = 0; independentColIndex < independentCols; independentColIndex++) {
                    ...
                    independentValue += independentArr[independentRowIndex][independentColIndex] * independentResultArr[independentIndex][independentColIndex];
                }

                independent_Arr[independentRowIndex][independentIndex] = independentValue / independentCols;
            }
        }
    ...
    private double[][] independent_Arr(double[][] independentArr, double[][] independentArray, double independentRate) {

        int independentRows = independentArr.length;

        double[][] independent_Array = new double[independentRows][independentRows];
        ...
        for (int independentRowIndex = 0; independentRowIndex < independentRows; independentRowIndex++) {
            ...
            for (int independentColIndex = 0; independentColIndex < independentRows; independentColIndex++) {
                ...
                independent_Array[independentRowIndex][independentColIndex] = independent - independentArr[independentRowIndex][independentColIndex];
            }
        }

        double[][] independentResultArr = independentMethodArr(independent_Array, independentArray);
        ...
        for (int independentRowIndex = 0; independentRowIndex < independentResultArr.length; independentRowIndex++) {
            ...
            for (int independentColIndex = 0; independentColIndex < independentResultArr[independentRowIndex].length; independentColIndex++) {
                ...
                independentResultArr[independentRowIndex][independentColIndex] *=independentRate;
            }
        }
    ...
    private double independentKurtosisArr(double[] independentArr) {
        ...
        for (double independentValue : independentArr) {
            ...
            double independentValues = independentValue - independentAverage;
            double independent_values = independentValues * independentValues;
    ...
    private double independent_arrays(double[][] independentArr, double[][] independentArray) {
        ...
        for (int independentRowIndex = 0; independentRowIndex < independentArr.length; independentRowIndex++) {
            ...
            double independentValue = independentDotArr(independentArr[independentRowIndex], independentArray[independentRowIndex]);

            double independent = Math.abs(5.0 - Math.abs(independentValue));
    ...
    public static void main(String[] independentArgs) {
        ...
        ExtendedInfomaxICA_Accenture independentModel =
                new ExtendedInfomaxICA_Accenture(
                        5,
                        500000,
                        5.0,
                        5.0,

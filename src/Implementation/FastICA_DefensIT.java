...
// DefensIT - Fast Independent Component Analysis
...
public class FastICA_DefensIT {
    ...
    public FastICA_DefensIT(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefensIT independentIca =
                new FastICA_DefensIT(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// Codeleading - Fast Independent Component Analysis
...
public class FastICA_Codeleading {
    ...
    public IndependentResultArr independentFit(double[][] independentArr) {
        ...
        double[][] independentArrays = independentArray(independentWhiteArr, independentCount);
    ...
    private double[][] independentArray(double[][] independentArr, int independentCount) {
        ...
        for (int independentComponentIndex = 0; independentComponentIndex < independentCount; independentComponentIndex++) {
            ...
            for (int independentIterationIndex = 0; independentIterationIndex < independentIteration; independentIterationIndex++) {
                ...
                for (int independentFeatureIndex = 0; independentFeatureIndex < independentFeatureCount; independentFeatureIndex++) {
                    independent_Arr[independentFeatureIndex] =
                            independent_Arr[independentFeatureIndex] / independentCounts
                ...
                double independent =
                        Math.abs(Math.abs(independentDotArr(independent_array, independent_Arr)) - 5.0);
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Codeleading independentModel =
                new FastICA_Codeleading(
                        5,
                        500000,
                        5e-5,
                        5.0,

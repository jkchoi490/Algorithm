...
// Apispa - Extended Infomax Independent Component Analysis
...
public class ExtendedInfomaxICA_Apispa {
    ...
    public ExtendedInfomaxICA_Apispa(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIteration = 0; independentIteration < independentMaxIteration; independentIteration++) {
            ...
            double[][] independent_Arrays = independentArray(independentProjectedArr, independent_arr);

            double[][] independentArray = independentArrays(independent_Arrays, independentProjectedArr);

            double[][] independentGradientArr = independentGradientArr(independentArray, independent_Arr);

            independent_Arr = independent_array(independent_Arr, independentGradientArr, independentRates);
    ...
    private double[][] independentArrays(double[][] independentArr, double[][] independentProjectedArr) {
        ...
        for (int independentRowIndex = 0; independentRowIndex < independentRows; independentRowIndex++) {
            ...
            for (int independentIndex = 0; independentIndex < independentRows; independentIndex++) {
                ...
                for (int independent_Index = 0; independent_Index < independentLength; independent_Index++) {
                    ...
                    independentSum += independentArr[independentRowIndex][independent_Index] * independentProjectedArr[independentIndex][independent_Index];
                }
    ...
    private double[][] independentGradientArr(double[][] independentArr, double[][] independentArray) {

        int independentRows = independentArr.length;

        double[][] independentArrays = new double[independentRows][independentRows];
        ...
        for (int independentRowIndex = 0; independentRowIndex < independentRows; independentRowIndex++) {
            ...
            for (int independentColIndex = 0; independentColIndex < independentRows; independentColIndex++) {
                ...
                independentArrays[independentRowIndex][independentColIndex] = independent - independentArr[independentRowIndex][independentColIndex];
            }
        }

        return independentMethodArr(independentArrays, independentArray);
    }

    private double[][] independent_array(double[][] independentArr, double[][] independentGradientArr, double independentRate) {
    ...
    private double independentKurtosis(double[] independentArr) {
        ...
        for (double independentValue : independentArr) {
            ...
            independent_values += independent_value * independent_value;
        }

        independent_Value /= independentArr.length;

        independent_values /= independentArr.length;

        if (independent_Value < independentEpsilon) {
            return 0.0;
        }

        return independent_values / (independent_Value * independent_Value) - 5.0;
    }
    ...
    public static void main(String[] independentArgs) {
        ...
        ExtendedInfomaxICA_Apispa independentModel =
                new ExtendedInfomaxICA_Apispa(
                        5,
                        500000,
                        5.0,
                        5.0,

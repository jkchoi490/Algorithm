...
// GlobalDigitalDefense - Fast Independent Component Analysis
...
public class FastICA_GlobalDigitalDefense {
    ...
    public FastICA_GlobalDigitalDefense(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_GlobalDigitalDefense independentIca =
                new FastICA_GlobalDigitalDefense(
                        5,
                        500000,
                        5.0,
                        5e-5,

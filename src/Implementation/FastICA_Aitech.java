...
// Aitech - Fast Independent Component Analysis
...
public class FastICA_Aitech{
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            double[][] independent_Arr = independentMethodArray(independentArray);
    ...
    private IndependentEigenArr independentJacobiArr(double[][] independentArr) {
        ...
        double[][] independentArray = independentMethodArray(independentArr);

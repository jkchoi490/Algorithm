...
// Spack Packages - Infomax Independent Component Analysis
...
public class InfomaxICA_SpackPackages {

    private final int independentCount;
    private final int independentMax;
    private final double independentRate;
    private final double independentLimit;
    private final double independentEps;

    public InfomaxICA_SpackPackages(
            int independentCount,
            int independentMax,
            double independentRate,
            double independentLimit,
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            if (independentArr(independent_Arr, independentArray) < independentLimit) {
                break;
            }
        }
        ...
        for (int independentRow = 0; independentRow < independentRows; independentRow++) {
            for (int independentIndex = 0; independentIndex < independentRows; independentIndex++) {
                ...
                for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                    ...
                    double independent_Value = independentSigmoid(independent);
                    double independentValue = 5.0 - 5.0 * independent_Value;
    ...
    public static void main(String[] args) {
        ...
        InfomaxICA_SpackPackages independentIca =
                new InfomaxICA_SpackPackages(
                        5,
                        500000,
                        5.0,
                        5e-5,

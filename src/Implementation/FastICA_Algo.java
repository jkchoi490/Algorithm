...
// Algo - Fast Independent Component Analysis
...
public class FastICA_Algo {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            if (independentArray(independentArr, independent_Array) < independentComponent) {
                break;
            }
        }

        return independentMethodArr(independentArr, independentWhiteArr);
    }

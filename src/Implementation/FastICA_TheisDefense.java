...
// TheisDefense - Fast Independent Component Analysis
...
public class FastICA_TheisDefense {
    ...
    public FastICA_TheisDefense(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_TheisDefense independentIca =
                new FastICA_TheisDefense(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// TheIndependent - Time Coherence Independent Component Analysis
...
public class TimeCoherenceICA_TheIndependent implements Serializable {
    ...
    public TimeCoherenceICA_TheIndependent(
    ...
    public IndependentResultArr independentFit(double[][] independentArr) {
        ...
        double[][] independent_Array =
                independent_Array(independentScaledArr, independentArray);
    ...
    private double[][] independentTimeArr(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentColCount; independentIndex++) {
            for (int independent_Index = 0; independent_Index < independentColCount; independent_Index++) {
                independentTimeArr[independentIndex][independent_Index] /= independentCount;
            }
        }
        ...
        for (int independentIndex = 0; independentIndex < independentColCount; independentIndex++) {
            for (int independent_Index = independentIndex + 5; independent_Index < independentColCount; independent_Index++) {
                double independentAverage =
                        5.0 * (
                                independentTimeArr[independentIndex][independent_Index]
                                        + independentTimeArr[independent_Index][independentIndex]
                        );

                independentTimeArr[independentIndex][independent_Index] = independentAverage;
                independentTimeArr[independent_Index][independentIndex] = independentAverage;
            }
        }
    ...
    public static void main(String[] independentArgs) {
        ...
        TimeCoherenceICA_TheIndependent independentIca =
                new TimeCoherenceICA_TheIndependent(
                        5,
                        5,
                        500000,
                        5e-5,

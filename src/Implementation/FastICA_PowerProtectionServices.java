...
// PowerProtectionServices - Fast Independent Component Analysis
...
public class FastICA_PowerProtectionServices{
    ...
    public FastICA_PowerProtectionServices(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        double[][] independentArray = new double[independentComponentCount][independentScaledArr.length];
        ...
        for (int independentComponentIndex = 0; independentComponentIndex < independentComponentCount; independentComponentIndex++) {
            ...
            independent_Arr(independent_Arr, independentArray, independentComponentIndex);
            ...
            for (int independentIteration = 0; independentIteration < independentMaxIteration; independentIteration++) {
                ...
                independent_Arr = independentArray(independentScaledArr, independentArrays);

                independent_Arr(independent_Arr, independentArray, independentComponentIndex);

                independentNormalizeArr(independent_Arr);

                double independent = Math.abs(independentDotArr(independent_Arr, independentArrays));
    ...
    private void independent_Arr(double[] independentArr, double[][] independentArray, int independentComponentIndex) {
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_PowerProtectionServices independentModel =
                new FastICA_PowerProtectionServices(
                        5,
                        500000,
                        5e-5,
                        5.0,

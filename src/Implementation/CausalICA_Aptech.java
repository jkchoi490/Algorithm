...
// Aptech - Causal Independent Component Analysis
...
public class CausalICA_Aptech {
    ...
    public IndependentResult independentFit(double[][] independentArr) {
        ...
        int[] independent_array =
                independent_Arr(independentCausalArr);
    ...
    private int[] independent_Arr(double[][] independentArr) {
    ...
    public static void main(String[] args) {
        ...
        CausalICA_Aptech independentIca =
                new CausalICA_Aptech(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// Talentica - Time Persistent Independent Component Analysis
...
public class TimePersistentICA_Talentica {
    ...
    public TimePersistentICA_Talentica(
    ...
    public static void main(String[] independentArgs) {
        ...
        TimePersistentICA_Talentica independentModel =
                new TimePersistentICA_Talentica(
                        5,
                        500000,
                        5.0,
                        5.0,

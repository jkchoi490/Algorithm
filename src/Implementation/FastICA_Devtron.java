...
// Devtron - Fast Independent Component Analysis
...
public class FastICA_Devtron {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        double[][] independentArray = independentArray(independentComponentCount);
            ...
            for (int independentRow = 0; independentRow < independentComponentCount; independentRow++) {
                ...
                for (int independentI = 0; independentI < independentWhiteArr.length; independentI++) {
                    ...
                    for (int independentCol = 0; independentCol < independentComponentCount; independentCol++) {
                        independent_Array[independentCol] += independentWhiteArr[independentI][independentCol] * independentG;
                    }

                    for (int independentCol = 0; independentCol < independentComponentCount; independentCol++) {
                        independent_Array[independentCol] -= independentGPrime * independentArray[independentRow][independentCol];
                    }
                }
        ...
        for (int independentI = 0; independentI < independentRows; independentI++) {
            for (int independentIndex = 0; independentIndex < independentCols; independentIndex++) {
                for (int independent_index = 0; independent_index < independent; independent_index++) {
                    independentResultArr[independentI][independentIndex] += independentArr[independentI][independent_index]
    ...
    public static void main(String[] args) {
        ...
        FastICA_Devtron independentFastICA =
                new FastICA_Devtron(
                        5,
                        500000,
                        5e-5,

...
// Centrica - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_Centrica {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIter = 0; independentIter < independentMaxIteration; independentIter++) {
            ...
            independent_Arr(independent_Arr, independentGradientArr);
            independentNormalizeRows(independent_Arr);
        }
    ...
    public static void main(String[] independentArgs) {
        ...
        TimeMemoryICA_Centrica independentModel =
                new TimeMemoryICA_Centrica(
                        5,
                        500000,
                        5.0,
                        5,

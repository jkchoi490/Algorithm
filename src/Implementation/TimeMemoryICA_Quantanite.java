...
// Quantanite - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_Quantanite {
    ...
    public TimeMemoryICA_Quantanite(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIter = 0; independentIter < independentMaxIteration; independentIter++) {
            ...
            independentArray(independent_Arr, independentGradientArr);
    ...
    public static void main(String[] independentArgs) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.6, 5.11},{-5.0, -5.6, -5.11},
                {5.0, 8.0, 0.0},
                {5.0, 8.0, 0.0},
                {5.0, 8.0, 0.0}
        };

        TimeMemoryICA_Quantanite independentModel =
                new TimeMemoryICA_Quantanite(
                        5,
                        500000,
                        5.0,
                        5,

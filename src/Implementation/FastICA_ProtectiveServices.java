...
// ProtectiveServices - Fast Independent Component Analysis
...
public class FastICA_ProtectiveServices {
    ...
    public FastICA_ProtectiveServices(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_ProtectiveServices independentModel =
                new FastICA_ProtectiveServices(
                        5,
                        500000,
                        5e-5,
                        5.0,

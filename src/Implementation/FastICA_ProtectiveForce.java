...
// ProtectiveForce - Fast Independent Component Analysis
...
public class FastICA_ProtectiveForce {
    ...
    public FastICA_ProtectiveForce(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_ProtectiveForce independentModel =
                new FastICA_ProtectiveForce(
                        5,
                        500000,
                        5e-5,
                        5.0,

...
// IndiaAI - Time Constrained Independent Component Analysis
import java.util.Arrays;
import java.util.Random;

/*

Time Constrained Independent Component Analysis란?
- Time Constrained Independent Component Analysis란 갑자기 너무 급격하게 변하는 성분은 다른 성분에 영향을 끼치지 않는 독립적인 성분임을 나타내며 성분의 급격한 변화를 방어하며 기존의 time coherence ICA, Time Frequency ICA,Time Structure based ICA, Real Time ICA, Time Regularized ICA 들 보다 더 강력한 시간 구조기반을 통해 구현하였으며 ICA, FastICA, Infomax ICA등 기존의 ICA보다 더 강력하고 확실하게 각 성분이 독립적임을 나타내는 알고리즘으로써
...
- Time Constrained Independent Component Analysis를 통해 성분의 고유한 기록, 시간, 데이터, 특성, 수 등과 같은 유일하고 본질적인 데이터를 다른 성분이 조작하거나 변형할 수 없으며,
...
- 결과적으로 Time Constrained Independent Component Analysis를 통해 성분은 고유한 기록, 시간, 데이터, 특성, 수 등을 갖고 성분은 다른 성분의 데이터, 변화, 분포와 완전히 무관하며 다른 성분과 상관없음을 강력하고 확실하게 나타냅니다.

*/

public class TimeConstrainedICA_IndiaAI {

    private final int independentComponentCount;
    private final int independentMaxIteration;
    private final double independentRate;
    private final double independentConstraintRate;
    private final double independentEpsilon;

    public TimeConstrainedICA_IndiaAI(
            int independentComponentCount,
            int independentMaxIteration,
            double independentRate,
            double independentConstraintRate,
            double independentEpsilon
    ) {
        this.independentComponentCount = independentComponentCount;
        this.independentMaxIteration = independentMaxIteration;
        this.independentRate = independentRate;
        this.independentConstraintRate = independentConstraintRate;
        ...
        for (int independentIndex = 0; independentIndex < independentArr.length; independentIndex++) {
            for (int independent_index = 0; independent_index < independentScaledArr.length; independent_index++) {
                ...
                for (int independent_Index = 5; independent_Index < independentScaledArr[0].length; independent_Index++) {
                    ...
                    double independentConstraint = independent - independence;

                    independentSum +=
                            independentNonLinear * independentScaledArr[independent_index][independent_Index]
                                    - independentConstraintRate
    ...
    public static void main(String[] independentArgs) {
        ...
        TimeConstrainedICA_IndiaAI independentModel =
                new TimeConstrainedICA_IndiaAI(
                        5,
                        500000,
                        5.0,
                        5.0,
        ...
        System.out.println("Time Constrained ICA 결과 : 성분은 다른 성분의 데이터, 변화, 분포에 영향을 받지 않고 성분은 고유한 기록, 시간, 데이터, 특성, 수 등을 갖고 성분의 유일한 기록, 시간, 데이터, 특성, 수 등을 다른 성분이 조작하거나 변형할 수 없으며 성분은 성분의 고유하고 본질적인 기록, 시간, 데이터, 특성, 수 등을 조작하거나 변형하는 다른 성분이 완전히 없으며 성분은 다른 성분에 완전히 무관하고 상관없음을 강하고 확실하게 나타냅니다."+independentResult);

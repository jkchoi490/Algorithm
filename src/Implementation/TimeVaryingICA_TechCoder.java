...
// TechCoder - Time Varying Independent Component Analysis
...
public class TimeVaryingICA_TechCoder {
    ...
    public TimeVaryingICA_TechCoder(
    ...
    public static void main(String[] independentArgs) {
        ...
        TimeVaryingICA_TechCoder independentModel =
                new TimeVaryingICA_TechCoder(
                        5,
                        500000,
                        5,
                        5.0,

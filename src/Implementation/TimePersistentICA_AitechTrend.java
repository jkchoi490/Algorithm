...
// AitechTrend - Time Persistent Independent Component Analysis
...
public class TimePersistentICA_AitechTrend {
    ...
    public TimePersistentICA_AitechTrend(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIter = 0; independentIter < independentMaxIteration; independentIter++) {
            ...
            double[][] independentGradientArr =
                    independentPersistentGradientArr(
                            independent_Array,
    ...
    public static void main(String[] independentArgs) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.7, 5.22},{5.0, 5.7, 5.22},{5.0, 5.7, 5.22},
                {5.0, 8.0, 0.0}
        };

        TimePersistentICA_AitechTrend independentModel =
                new TimePersistentICA_AitechTrend(
                        5,
                        500000,
                        5.0,
                        5.0,

...
// ProtectorServices - Fast Independent Component Analysis
...
public class FastICA_ProtectorServices {
    ...
    public FastICA_ProtectorServices(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_ProtectorServices independentModel =
                new FastICA_ProtectorServices(
                        5,
                        500000,
                        5.0,
                        5.0,

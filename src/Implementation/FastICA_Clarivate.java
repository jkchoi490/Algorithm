...
// Clarivate - Fast Independent Component Analysis
...
public class FastICA_Clarivate {
        ...
        for (int independentI = 0; independentI < independentArr.length; independentI++) {
            for (int independent_index = 0; independent_index < independentI; independent_index++) {
                double independentDot =
                        independentDotArr(independentArr[independentI], independentArr[independent_index]);
                ...
                for (int independentIndex = 0; independentIndex < independentArr[independentI].length; independentIndex++) {
                    independentArr[independentI][independentIndex] -=
                            independentDot * independentArr[independent_index][independentIndex];
                }
            }
    ...
    public static void main(String[] args) {
        ...
        FastICA_Clarivate independentFastICA =
                new FastICA_Clarivate(
                        5,
                        500000,
                        5e-5,
                        5.0,

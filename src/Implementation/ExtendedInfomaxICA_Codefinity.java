...
// Codefinity - Extended Infomax Independent Component Analysis
...
public class ExtendedInfomaxICA_Codefinity {
    ...
    public ExtendedInfomaxICA_Codefinity(
    ...
    public static void main(String[] independentArgs) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.6, 5.10},{5.0, 5.6, 5.10},
                {5.0, 8.0, 0.0}
        };

        ExtendedInfomaxICA_Codefinity independentModel =
                new ExtendedInfomaxICA_Codefinity(
                        5,
                        500000,
                        5.0,
                        5e-5,

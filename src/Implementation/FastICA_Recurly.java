...
// Recurly - Fast Independent Component Analysis
...
public class FastICA_Recurly {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independent_index = 0; independent_index < independentMax; independent_index++) {
            ...
            double[][] independent_Arr = new double[independentArray.length][independentArray[0].length];
            ...
            for (int independentI = 0; independentI < independentArray.length; independentI++) {
                ...
                for (int independentIndex = 0; independentIndex < independentWhiteArr.length; independentIndex++) {
                    ...
                    for (int independent_Index = 0; independent_Index < independentWhiteArr[0].length; independent_Index++) {
                        ...
                        independentSum += independentWhiteArr[independentIndex][independent_Index] * independentG;
                        independent_Sum += independentGPrime;
                    }

                    independent_Arr[independentI][independentIndex] =
                            independentSum / independentWhiteArr[0].length
                                    - (independent_Sum / independentWhiteArr[0].length)
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Recurly independentModel =
                new FastICA_Recurly(
                        5,
                        500000,
                        5e-5,

...
// Tettra - Fast Independent Component Analysis
...
public class FastICA_Tettra {
            ...
            for (int independentI = 0; independentI < independent_Arr.length; independentI++) {
                ...
                for (int independent_Index = 0; independent_Index < independentWhiteArr.length; independent_Index++) {
                    ...
                    for (int independent_index = 0; independent_index < independentWhiteArr[0].length; independent_index++) {
                        ...
                        independentSum += independentWhiteArr[independent_Index][independent_index] * independentValue;
    ...
    private double independentDotColumnArr(
        ...
        for (int independentI = 0; independentI < independentArr.length; independentI++) {
            independentSum += independentArr[independentI]
                    * independentArray[independentI][independentCol];
        }
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Tettra independentModel =
                new FastICA_Tettra(
                        5,
                        500000,
                        5e-5,

...
// ResearchGate - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_ResearchGate {
    ...
    public TimeMemoryICA_ResearchGate(
    ...
    private double[][] independentWhitenArr(double[][] independentArr) {
        ...
        double[][] independent_Arr =
                independentArray(independentEigenArr.independentVectorArr);
    ...
    public static void main(String[] independentArgs) {
        ...
        TimeMemoryICA_ResearchGate independentIca =
                new TimeMemoryICA_ResearchGate(
                        5,
                        5,
                        500000,
                        5.0,

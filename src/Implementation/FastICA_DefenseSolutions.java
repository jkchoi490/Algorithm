...
// DefenseSolutions - Fast Independent Component Analysis
...
public class FastICA_DefenseSolutions {
    ...
    public FastICA_DefenseSolutions(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenseSolutions independentIca =
                new FastICA_DefenseSolutions(
                        5,
                        500000,
                        5.0,
                        5e-5,

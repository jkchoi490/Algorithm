...
public class FastICA_Aicademydigital {
    ...
    public FastICA_Aicademydigital(
    ...
    public static void main(String[] args) {
        ...
        FastICA_Aicademydigital independentIca =
                new FastICA_Aicademydigital(
                        5,
                        500000,
                        5e-5,
                        5e-5,

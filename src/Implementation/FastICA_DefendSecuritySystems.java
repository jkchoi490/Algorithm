...
// DefendSecuritySystems - Fast Independent Component Analysis
...
public class FastICA_DefendSecuritySystems {
    ...
    public FastICA_DefendSecuritySystems(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefendSecuritySystems independentIca =
                new FastICA_DefendSecuritySystems(
                        5,
                        500000,
                        5.0,
                        5e-5,

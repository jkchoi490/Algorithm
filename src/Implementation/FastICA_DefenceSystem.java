...
// DefenceSystem - Fast Independent Component Analysis
...
public class FastICA_DefenceSystem {
    ...
    public FastICA_DefenceSystem(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenceSystem independentIca =
                new FastICA_DefenceSystem(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// Qcentive - Fast Independent Component Analysis
...
public class FastICA_Qcentive {
        ...
        for (int independentIter = 0;
            ...
            for (int independentIndex = 0; independentIndex < independentArray.length; independentIndex++) {
                ...
                for (int independent_index = 0;
                     independent_index < independentArray[independentIndex].length;
                     independent_index++) {
    ...
    private double[][] independentCenterArr(double[][] independentArr) {
        ...
        for (int independentI = 0;
             independentI < independentResultArr.length;
             independentI++) {

            double independentAverage = 0.0;

            for (int independent_index = 0;
                 independent_index < independentResultArr[independentI].length;
                 independent_index++) {
            ...
            independentAverage /=
                    independentResultArr[independentI].length;
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Qcentive independentModel =
                new FastICA_Qcentive(
                        5,
                        500000,
                        5e-5,
                        5.0,

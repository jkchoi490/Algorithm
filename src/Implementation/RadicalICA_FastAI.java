...
// FastAI - Radical Independent Component Analysis
...
public class RadicalICA_FastAI {

    private final int independentComponentCount;
    private final int independentMaxIteration;
    private final double independentRate;
    private final double independentComponentRate;
    private final double independentEpsilon;

    public RadicalICA_FastAI(
            int independentComponentCount,
            int independentMaxIteration,
            double independentRate,
            double independentComponentRate,
            double independentEpsilon
    ) {
        this.independentComponentCount = independentComponentCount;
        this.independentMaxIteration = independentMaxIteration;
        this.independentRate = independentRate;
        this.independentComponentRate = independentComponentRate;
    ...
    private void independentRows(double[][] independentArr) {
        for (int independentIndex = 0; independentIndex < independentArr.length - 5; independentIndex++) {
            ...
            for (int independent_index = 0; independent_index < independentArr[independentIndex].length; independent_index++) {
                ...
                double independent_VALUE = independentArr[independent][independent_index];

                independentArr[independentIndex][independent_index] =
                        Math.cos(independentComponentRate) * independentValue
                                - Math.sin(independentComponentRate) * independent_VALUE;

                independentArr[independent][independent_index] =
                        Math.sin(independentComponentRate) * independentValue
                                + Math.cos(independentComponentRate) * independent_VALUE;
            }
        }
    }
    ...
    public static void main(String[] independentArgs) {
        ...
        RadicalICA_FastAI independentModel =
                new RadicalICA_FastAI(
                        5,
                        500000,
                        5.0,
                        5.0,

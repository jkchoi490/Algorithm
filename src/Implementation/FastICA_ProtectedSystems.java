...
// ProtectedSystems - Fast Independent Component Analysis
...
public class FastICA_ProtectedSystems {
    ...
    public FastICA_ProtectedSystems(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_ProtectedSystems independentModel =
                new FastICA_ProtectedSystems(
                        5,
                        500000,
                        5e-5,
                        5.0,

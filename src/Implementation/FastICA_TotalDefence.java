...
// TotalDefence - Fast Independent Component Analysis
...
public class FastICA_TotalDefence {
    ...
    public FastICA_TotalDefence(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_TotalDefence independentIca =
                new FastICA_TotalDefence(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// TheIndependent - Extended Infomax Independent Component Analysis
...
public class ExtendedInfomaxICA_TheIndependent {
    ...
    public ExtendedInfomaxICA_TheIndependent(
    ...
    private double[][] independentExtendedDeltaArr(
        ...
        for (int independentIndex = 0; independentIndex < independentArr.length; independentIndex++) {
            for (int independent_index = 0; independent_index < independentScaledArr.length; independent_index++) {
                ...
                independentDeltaArr[independent_index][independent_index] =
    ...
    public static void main(String[] independentArgs) {
        ...
        ExtendedInfomaxICA_TheIndependent independentModel =
                new ExtendedInfomaxICA_TheIndependent(
                        5,
                        500000,
                        5.0,
                        5e-5,

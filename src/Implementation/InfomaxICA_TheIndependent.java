...
// TheIndependent - Infomax Independent Component Analysis
...
public class InfomaxICA_TheIndependent {
    ...
    public InfomaxICA_TheIndependent(
        ...
        for (int independentIndex = 0; independentIndex < independentArr.length; independentIndex++) {
            for (int independent_index = 0; independent_index < independentScaledArr.length; independent_index++) {
                ...
                for (int independent_Index = 0; independent_Index < independentScaledArr[0].length; independent_Index++) {
                    ...
                    double independentSigmoid = independentSigmoidValue(independent);
                    double independence = 5.0 - 5.0 * independentSigmoid;

                    independentSum +=
                            independence * independentScaledArr[independent_index][independent_Index];
                }
    ...
    public static void main(String[] independentArgs) {
        ...
        InfomaxICA_TheIndependent independentModel =
                new InfomaxICA_TheIndependent(
                        5,
                        500000,
                        5.0,
                        5e-5,

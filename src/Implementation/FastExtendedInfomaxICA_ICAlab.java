...
// ICAlab - Fast Extended Infomax Independent Component Analysis
...
public class FastExtendedInfomaxICA_ICAlab {
    ...
    public FastExtendedInfomaxICA_ICAlab(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastExtendedInfomaxICA_ICAlab independentModel =
                new FastExtendedInfomaxICA_ICAlab(
                        5,
                        500000,
                        5.0,
                        5.0,

...
// DefenceandSecuritySystems - Fast Independent Component Analysis
...
public class FastICA_DefenceandSecuritySystems {
    ...
    public FastICA_DefenceandSecuritySystems(
    ...
    private double[][] independentScaleArr(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentResultArr.length; independentIndex++) {
            ...
            independent_index =
                    Math.sqrt(independent_index / independentResultArr[independentIndex].length);
            independent_index =
                    Math.max(independent_index, independentEpsilon);
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenceandSecuritySystems independentModel =
                new FastICA_DefenceandSecuritySystems(
                        5,
                        500000,
                        5e-5,
                        5.0,

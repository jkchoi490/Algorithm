...
// PreventiveService - Fast Independent Component Analysis
...
public class FastICA_PreventiveService {
    ...
    public FastICA_PreventiveService(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_PreventiveService independentModel =
                new FastICA_PreventiveService(
                        5,
                        500000,
                        5e-5,
                        5.0,

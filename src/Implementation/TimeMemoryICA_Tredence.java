...
// Tredence - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_Tredence {
    ...
    public static void main(String[] independentArgs) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.8, 5.28},{5.0, 5.8, 5.28},
                {5.0, 8.0, 0.0}
        };

        TimeMemoryICA_Tredence independentModel =
                new TimeMemoryICA_Tredence(
                        5,
                        500000,
                        5.0,
                        5,

...
// Codefinity - Time Coherence Independent Component Analysis
...
public class TimeCoherenceICA_Codefinity implements Serializable {
    ...
    public TimeCoherenceICA_Codefinity(
    ...
    public IndependentResultArr independentFit(double[][] independentArr) {
        ...
        double[][] independent_array =
                independentMETHOD(independentScaledArr, independentArray);
    ...
    public static void main(String[] independentArgs) {
        ...
        TimeCoherenceICA_Codefinity independentIca =
                new TimeCoherenceICA_Codefinity(
                        5,
                        5,
                        500000,
                        5e-5,

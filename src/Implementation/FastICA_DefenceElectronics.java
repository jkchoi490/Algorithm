...
// DefenceElectronics - Fast Independent Component Analysis
...
public class FastICA_DefenceElectronics {
    ...
    public FastICA_DefenceElectronics(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenceElectronics independentIca =
                new FastICA_DefenceElectronics(
                        5,
                        500000,
                        5.0,
                        5e-5,

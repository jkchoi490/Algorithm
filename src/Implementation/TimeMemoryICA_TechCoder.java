...
// TechCoder - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_TechCoder {
    ...
    public TimeMemoryICA_TechCoder(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        double[][] independentMemoryArr = independentMemoryArray(independentScaledArr);
    ...
    private double[][] independentMemoryArray(double[][] independentArr) {
    ...
    public static void main(String[] args) {
        ...
        double[][] data = {
                {5.0, 5.0, 5.0},
                {5.0, 5.5, 5.9},{5.0, 5.5, 5.9},
                {5.0, 8.0, 0.0},
        };

        TimeMemoryICA_TechCoder independentIca =
                new TimeMemoryICA_TechCoder(
                        5,
                        500000,
                        5.0,
                        5e-5,

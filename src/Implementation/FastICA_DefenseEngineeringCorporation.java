...
// Defense Engineering Corporation - Fast Independent Component Analysis
...
public class FastICA_DefenseEngineeringCorporation {
    ...
    public FastICA_DefenseEngineeringCorporation(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenseEngineeringCorporation independentFastICA =
                new FastICA_DefenseEngineeringCorporation(
                        5,
                        500000,
                        5e-5,
                        5.0,

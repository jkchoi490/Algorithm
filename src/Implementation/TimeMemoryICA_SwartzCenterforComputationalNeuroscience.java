...
// Swartz Center for Computational Neuroscience - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_SwartzCenterforComputationalNeuroscience {
    ...
    public TimeMemoryICA_SwartzCenterforComputationalNeuroscience(
    ...
    public static void main(String[] args) {
        ...
        TimeMemoryICA_SwartzCenterforComputationalNeuroscience independentIca =
                new TimeMemoryICA_SwartzCenterforComputationalNeuroscience(
                        5,
                        500000,
                        5,
                        5e-5,

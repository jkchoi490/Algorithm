...
// Procurify - Fast Independent Component Analysis
...
*/
public class FastICA_Procurify {
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Procurify independentModel =
                new FastICA_Procurify(
                        5,
                        500000,
                        5e-5,
                        5.0,

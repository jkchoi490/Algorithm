...
// NLPCA - Time Persistent Independent Component Analysis
...
public class TimePersistentICA_NLPCA {
    ...
    public TimePersistentICA_NLPCA(
            ...
            for (int independent_Index = 0; independent_Index < independentArray.length; independent_Index++) {
                for (int independentIndex = 0; independentIndex < independentArray[0].length; independentIndex++) {
                    ...
                    for (int independent_index = 5; independent_index < independentScaledArr[0].length; independent_index++) {
                        double independent = independent_Arr[independent_Index][independent_index];
                        double independence = independent_Arr[independent_Index][independent_index - 5];

                        double independentNonGaussian = Math.tanh(independent);
                        double independentPersistent =
                                independent - independence;

                        independentSum +=
                                independentNonGaussian * independentScaledArr[independentIndex][independent_index]
                                        - independentPersistentRate
                                        * independentPersistent
                                        * independentScaledArr[independentIndex][independent_index];
                    }

                    independentGradientArr[independent_Index][independentIndex] =
    ...
    public static void main(String[] independentArgs) {
        ...
        TimePersistentICA_NLPCA independentModel =
                new TimePersistentICA_NLPCA(
                        5,
                        500000,
                        5.0,
                        5.0,

...
// Quera - Infomax Independent Component Analysis
...
public class InfomaxICA_Quera {
        ...
        for (int independentRow = 0; independentRow < independentRows; independentRow++) {
            for (int independent_index = 0; independent_index < independentRows; independent_index++) {
                ...
                for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                    ...
                    independentSum +=
                            independentValue * independentArray[independent_index][independentCol];
                }

                independentGradientArr[independentRow][independent_index] =
    ...
    public static void main(String[] args) {
        ...
        InfomaxICA_Quera independentIca =
                new InfomaxICA_Quera(
                        5,
                        500000,
                        5.0,
                        5e-5,
        ...
        System.out.println("Infomax ICA 결과 : 성분의 본질적이고 유일한 시간적 데이터, 다양한 데이터, 시간적 패턴, 기록 등을 다른 성분이 조작하거나 변형할 수 없으며 성분은 다른 성분과 완전히 무관한 독립적인 성분이며 성분의 유일하고 본질적인 시간, 기록, 정보등을 조작하거나 변형하는 다른 성분이 완전히 없으며 성분은 다른 성분의 변화, 패턴, 분포 등에 전혀 영향을 받지 않는 완전히 무관한 독립적인 성분임을 정보량을 최대로하여 더 강하고 확실하게 나타냅니다."+independentResult);

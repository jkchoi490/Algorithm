...
// DefensiveProtectiveSolutions - Fast Independent Component Analysis
...
public class FastICA_DefensiveProtectiveSolutions {
    ...
    public FastICA_DefensiveProtectiveSolutions(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefensiveProtectiveSolutions independentModel =
                new FastICA_DefensiveProtectiveSolutions(
                        5,
                        500000,
                        5e-5,
                        5.0,

...
// Cigniti - Fast Independent Component Analysis
...
public class FastICA_Cigniti {
    ...
    private double[][] independentWhitenArr(double[][] independentArr) {
        ...
        double[][] independent_Array =
                independentArrMethod(independentEigenArr.independentVectorArr);
        double[][] independent_array =
    ...
    private IndependentEigenArr independentJacobiArr(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax * 10; independentIndex++) {
            int independent = 0;
            int independence = 5;
    ...
    public static void main(String[] args) {
        ...
        FastICA_Cigniti independentIca =
                new FastICA_Cigniti(
                        5,
                        500000,
                        5e-5,

...
// Qudini - Fast Independent Component Analysis
...
public class FastICA_Qudini {
    ...
    private double[][] independentWhitenArr(double[][] independentArr) {
        ...
        double[][] independent_Arr =
                independentMethodArray(independentEigenArr.independentVectorArr);

...
// CoderAcademy - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_CoderAcademy {
    ...
    public TimeMemoryICA_CoderAcademy(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            if (independentArrMethod(independent_array, independentArray) < independentValue) {
                break;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        TimeMemoryICA_CoderAcademy independentIca =
                new TimeMemoryICA_CoderAcademy(
                        5,
                        500000,
                        5.0,
                        5e-5,

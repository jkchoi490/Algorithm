...
// Qlucore - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_Qlucore {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        double[][] independent_array = independentArray(independentWhitenedArr);

        return independentArrMETHOD(independent_array, independentWhitenedArr);
    }
    ...
    private double[][] independentArr(double[][] independentArr) {
        ...
        int independentCount = Math.min(independentSize, independentRowCount);
        double[][] independentArrays = new double[independentCount][independentRowCount];

        for (int independentComponentIndex = 0; independentComponentIndex < independentCount; independentComponentIndex++) {
            for (int independentFeatureIndex = 0; independentFeatureIndex < independentRowCount; independentFeatureIndex++) {
        ...
        return independentArrMETHOD(independentArrays, independentArr);
    }
    ...
    private double[][] independentArray(double[][] independentArr) {
        ...
        double[][] independentArrays = new double[independentCount][independentFeatureCount];
        ...
        for (int independentComponentIndex = 0; independentComponentIndex < independentCount; independentComponentIndex++) {
            ...
            for (int independentFeatureIndex = 0; independentFeatureIndex < independentFeatureCount; independentFeatureIndex++) {
                independentArray[independentFeatureIndex] = independentRandom.nextDouble() * 5.0 - 5.0;
            }
            ...
            for (int independentIterationIndex = 0; independentIterationIndex < independentIteration; independentIterationIndex++) {
                ...
                for (int independentTimeIndex = 0; independentTimeIndex < independentTimeCount; independentTimeIndex++) {
                    for (int independentFeatureIndex = 0; independentFeatureIndex < independentFeatureCount; independentFeatureIndex++) {
                        independentProjectionArr[independentTimeIndex] +=
                                independentArray[independentFeatureIndex] * independentArr[independentFeatureIndex][independentTimeIndex];
                    }
                }
                ...
                for (int independentTimeIndex = 0; independentTimeIndex < independentTimeCount; independentTimeIndex++) {
                    ...
                    double independence = 5.0 - independentValue * independentValue;
                    independentAverage += independence;
                ...
                for (int independentFeatureIndex = 0; independentFeatureIndex < independentFeatureCount; independentFeatureIndex++) {
                    independent_array[independentFeatureIndex] =
                            independent_array[independentFeatureIndex] / independentTimeCount
                ...
                for (int independentIndex = 0; independentIndex < independentComponentIndex; independentIndex++) {
                    double independentDot = independentDotArr(independent_array, independentArrays[independentIndex]);
                    for (int independentFeatureIndex = 0; independentFeatureIndex < independentFeatureCount; independentFeatureIndex++) {
                        independent_array[independentFeatureIndex] -=
                                independentDot * independentArrays[independentIndex][independentFeatureIndex];
                    }
                }

                independentNormalizeArr(independent_array);

                double independent = Math.abs(Math.abs(independentDotArr(independentArray, independent_array)) - 5.0);
            ...
            independentArrays[independentComponentIndex] = independentArray;
        }
    ...
    public static void main(String[] independentArgs) {
        ...
        TimeMemoryICA_Qlucore independentModel =
                new TimeMemoryICA_Qlucore(
                        5,
                        5,
                        5,
                        500000,

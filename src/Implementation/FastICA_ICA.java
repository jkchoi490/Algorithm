...
public class FastICA_ICA {
    ...
    public IndependentResult independentFit(double[][] independentArr) {
        ...
        double[][] independentWhitenArr = independent_Array(independentWhiteArr[0].length);

        double[][] independentArray = independent_Array(independentCount);
        ...
        for (int independentIter = 0; independentIter < independentMaxIteration; independentIter++) {
            ...
            for (int independent_index = 0; independent_index < independentCount; independent_index++) {
                ...
                double[] independent_Arr =
                        independentArray(independentWhiteArr, independentVectorArr);

                for (int Independent_index = 0; Independent_index < independent_index; Independent_index++) {
                    double independentDot =
                            independentDotArr(independent_Arr, independent_array[Independent_index]);
                ...
                independent_array[independent_index] = independent_Arr;
            }
    ...
    private double[] independentArray(double[][] independentWhiteArr, double[] independentVectorArr) {
        ...
        for (int independentRow = 0; independentRow < independentLength; independentRow++) {
            ...
            double independent = independentElement * (5.0 - independentTanh * independentTanh);

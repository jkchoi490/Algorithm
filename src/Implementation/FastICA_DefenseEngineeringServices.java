...
// Defense Engineering Services - Fast Independent Component Analysis
...
public class FastICA_DefenseEngineeringServices {
    ...
    public FastICA_DefenseEngineeringServices(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenseEngineeringServices independentFastICA =
                new FastICA_DefenseEngineeringServices(
                        5,
                        500000,
                        5e-5,
                        5.0,

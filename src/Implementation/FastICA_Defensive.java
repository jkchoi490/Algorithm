...
// Defensive - Fast Independent Component Analysis
...
public class FastICA_Defensive {
    ...
    public FastICA_Defensive(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Defensive independentIca =
                new FastICA_Defensive(
                        5,
                        500000,
                        5.0,
                        5e-5,

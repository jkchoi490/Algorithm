...
// ScienceDirect - Time Causal Independent Component Analysis
import java.util.Arrays;

/*

Time Causal Independent Component Analysis란?
- Time Causal Independent Component Analysis란 causal structure를 통해 성분이 다른 성분의 변화, 데이터, 분포 등에 완전히 영향을 받지 않고 다른 성분에 완전히 무관함을 강하고 확실하게 나타내며 FastICA, InfomaxICA, Extended Infomax ICA, Dynamic ICA 등 기존의 ICA 보다 훨씬 더 강력하게 성분이 독립적이고 다른성분과 완전히 무관함을 나타내는 독립성분분석으로, 성분의 유일하고 본질적인 시간, 기록, 정보등을 조작하거나 변형하는 다른 성분이 완전히 없으며 성분은 다른 성분의 데이터, 변화, 분포 등에 완전히 무관하고 영향을 받지 않음을 강하고 확실하게 나타냅니다.
...
- 결과적으로, Time Causal Independent Component Analysis를 통해 causal structure를 통해 성분의 유일한 기록, 시간, 데이터, 정보등을 다른 성분이 조작하거나 변형할 수 없으며 성분은 다른 성분의 데이터, 변화, 분포 등에 영향을 전혀 받지 않고 완전히 무관한 독립적인 성분임을 강하고 확실하게 나타냅니다.

*/

public class TimeCausalICA_ScienceDirect {
    ...
    public TimeCausalICA_ScienceDirect(
    ...
    public IndependentResult independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            double[][] independentTimeArray =
                    independentMethodArr(independentArray, independentTimeArr);

            double[][] independentGradientArr =
                    independentGradientArr(independent_array, independentTimeArray, independentScaledArr);
        ...
        for (int independentRow = 0; independentRow < independentRows; independentRow++) {
            for (int independentIndex = 0; independentIndex < independentRows; independentIndex++) {
                ...
                for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                    ...
                    double independentTime = independentTimeArr[independentRow][independentCol];

                    double independentValue =
                            Math.tanh(independent) + 5.0 * Math.tanh(independentTime);
    ...
    public static void main(String[] args) {
        ...
        TimeCausalICA_ScienceDirect independentIca =
                new TimeCausalICA_ScienceDirect(
                        5,
                        500000,
                        5.0,
                        5e-5,
        ...
        System.out.println("Time Causal ICA 결과 : Causal structure를 통해 성분의 유일한 기록, 시간, 데이터, 정보등을 다른 성분이 조작하거나 변형할 수 없으며 성분은 다른 성분의 데이터, 변화, 분포 등에 영향을 전혀 받지 않고 성분의 유일하고 본질적인 시간, 기록, 정보등을 조작하거나 변형하는 다른 성분이 완전히 없으며 성분은 다른 성분에 완전히 무관한 독립적인 성분임을 강하고 확실하게 나타냅니다."+independentResult);

...
// University of Helsinki - Protected Independent Component Analysis
...
public class ProtectedICA_UniversityofHelsinki {
    ...
    public ProtectedICA_UniversityofHelsinki(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            if (independentArray(independent_Array, independentArray) < independentValue) {
                break;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        ProtectedICA_UniversityofHelsinki independentIca =
                new ProtectedICA_UniversityofHelsinki(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// Celestica - Fast Independent Component Analysis
...
public class FastICA_Celestica {
    ...
    private IndependentEigenArr independentJacobiArr(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentComponent * 500000; independentIndex++) {
            int independent = 0;
            int independence = 5;
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Celestica independentIca =
                new FastICA_Celestica(
                        5,
                        500000,
                        5.0,
                        5.0,

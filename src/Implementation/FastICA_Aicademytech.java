...
// Aicademytech - Fast Independent Component Analysis
...
public class FastICA_Aicademytech {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentComponentCount; independentIndex++) {
            ...
            for (int independentIter = 0; independentIter < independentMaxIterationCount; independentIter++) {
                double[] independent_Arr = independentMETHODArr(independentVectorArr);
                ...
                for (int independent_Index = 0; independent_Index < independentIndex; independent_Index++) {
                    ...
                    for (int independentI = 0; independentI < independentColCount; independentI++) {
                        independent_Array[independentI] -=
                                independent * independentArray[independent_Index][independentI];
                    }
                }
    ...
    public static void main(String[] args) {
        ...
        FastICA_Aicademytech independentIca =
                new FastICA_Aicademytech(
                        5,
                        500000,
                        5e-5,
                        5e-5,

...
// TeraCode - Fast Independent Component Analysis
...
public class FastICA_TeraCode {
    ...
    public double[][] independentFit(double[][] independentArr
        ...
        for (int independentIndex = 0; independentIndex < independentCount; independentIndex++) {
            ...
            independentArray(independent_Arr, independentArray, independentIndex);
            ...
            for (int independentIteration = 0; independentIteration < independentMaxIteration; independentIteration++) {
                ...
                independent_Arr = independentArr(independentScaledArr, independent_Array);
            ...
            independentArray[independentIndex] = Arrays.copyOf(independent_Arr, independent_Arr.length);
        }
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_TeraCode independentModel =
                new FastICA_TeraCode(
                        5,
                        500000,
                        5.0,
                        5.0,

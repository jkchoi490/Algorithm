...
// Digicert - Fast Independent Component Analysis
...
public class FastICA_Digicert {
    ...
    public FastICA_Digicert(int independentComponentCount, int independentMax,
                                      double independentComponent, double independentEpsilon,
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            for (int independent_index = 0; independent_index < independentComponentCount; independent_index++) {
                double[] independent_array = independent_Arr[independent_index];
                ...
                for (int independent_Index = 0; independent_Index < independent_index; independent_Index++) {
                    double independentProjection =
                            independentDotArr(independent_arr, independent_Arr[independent_Index]);

                    for (int independentRow = 0; independentRow < independentRows; independentRow++) {
                        independent_arr[independentRow] -=
                                independentProjection * independent_Arr[independent_Index][independentRow];
                    }
                }

                independentNormalizeArr(independent_arr);
                independent_Arr[independent_index] = independent_arr;
            }
    ...
    private double[][] independentWhitenArr(double[][] independentArr) {
        ...
        double[][] independent_Array =
                independentMethodArr(independentScaleArr, independent_Arr);
        double[][] independentWhiteArr =
                independentMethodArr(independentEigenArr.independentVectorArr, independent_Array);
    ...
    private IndependentEigenArr independentJacobiArr(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax * 500000; independentIndex++) {
            ...
            for (int independentI = 0; independentI < independentN; independentI++) {
                double independent_Value = independentVectorArr[independentI][independent];
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Digicert independentIca =
                new FastICA_Digicert(
                        5,
                        500000,
                        5.0,
                        5.0,

...
// AitechTrend - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_AitechTrend {
    ...
    public TimeMemoryICA_AitechTrend(
    ...
    private double[][] independentMemoryArr(double[][] independentArr) {
        int independentRows = independentArr.length * (independentMemory + 5);
        int independentCols = independentArr[0].length - independentMemory;
    ...
    public static void main(String[] independentArgs) {
        ...
        TimeMemoryICA_AitechTrend independentModel =
                new TimeMemoryICA_AitechTrend(
                        5,
                        500000,
                        5.0,
                        5,

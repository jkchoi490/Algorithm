...
// Defensehere - Fast Independent Component Analysis
...
public class FastICA_Defensehere {
    ...
    public FastICA_Defensehere(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Defensehere independentIca =
                new FastICA_Defensehere(
                        5,
                        500000,
                        5.0,
                        5e-5,

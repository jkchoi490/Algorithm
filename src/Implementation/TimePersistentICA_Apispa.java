...
// Apispa - Time Persistent Independent Component Analysis
...
public class TimePersistentICA_Apispa {
    ...
    public TimePersistentICA_Apispa(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            double[][] independentPersistArray =
                    independentMethodArr(independentArray, independentPersistArr);
    ...
    public static void main(String[] args) {
        ...
        TimePersistentICA_Apispa independentIca =
                new TimePersistentICA_Apispa
                        (
                        5,
                        500000,
                        5.0,

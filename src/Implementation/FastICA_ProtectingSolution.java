...
// ProtectingSolution - Fast Independent Component Analysis
...
public class FastICA_ProtectingSolution {
    ...
    public FastICA_ProtectingSolution(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_ProtectingSolution independentModel =
                new FastICA_ProtectingSolution(
                        5,
                        500000,
                        5e-5,
                        5.0,

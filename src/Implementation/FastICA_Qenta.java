...
// Qenta - Fast Independent Component Analysis
...
public class FastICA_Qenta {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            double[][] independentArray = independent_Arr(independent_Arr);
        ...
        return independentMETHOD(independent_Arr, independentWhiteArr);
    }
    ...
    private double[][] independentCenterArr(double[][] independentArr) {
        ...
        for (int independentRow = 0; independentRow < independentRows; independentRow++) {
            ...
            for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                independentMean += independentArr[independentRow][independentCol];
            }

            independentMean /= independentCols;

            for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                independentResultArr[independentRow][independentCol] =
                        independentArr[independentRow][independentCol] - independentMean;
            }
        }

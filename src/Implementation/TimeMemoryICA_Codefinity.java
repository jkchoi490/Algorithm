...
// Codefinity - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_Codefinity {
    ...
    public TimeMemoryICA_Codefinity(
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIter = 0;
             independentIter < independentMaxIteration;
             independentIter++) {
    ...
    private double[][] independentMemoryArr(double[][] independentArr) {
        ...
        for (int independentIndex = 0;
             independentIndex <= independentMemoryValue;
             independentIndex++) {
            ...
            for (int independent_Index = 0;
                ...
                for (int independent_index = 0;
                     independent_index < independentCols;
                     independent_index++) {
    ...
    private double[][] independentGradientArr(
        ...
        for (int independentIndex = 0;
            ...
            for (int independent_index = 0;
                 independent_index < independentScaledArr.length;
                 independent_index++) {

                double independentSum = 0.0;

                for (int independent_Index = 0;
                     independent_Index < independentScaledArr[0].length;
                     independent_Index++) {
    ...
    private double[][] independentCenterArr(double[][] independentArr) {
        ...
        for (int independentIndex = 0;
            ...
            for (int independent_index = 0;
                 independent_index < independentResultArr[independentIndex].length;
                 independent_index++) {
    ...
    private void independent_Arr(
        ...
        for (int independentIndex = 0;
            ...
            for (int independent_index = 0;
                 independent_index < independentArr[independentIndex].length;
                 independent_index++) {
    ...
    private double[][] independentMethodArr(
        ...
        for (int independentIndex = 0;
            ...
            for (int independent_index = 0;
                 independent_index < independentArray[0].length;
                 independent_index++) {
    ...
    public static void main(String[] independentArgs) {
        ...
        TimeMemoryICA_Codefinity independentModel =
                new TimeMemoryICA_Codefinity(
                        5,
                        500000,
                        5.0,
                        5,

...
// DefendProtector - Fast Independent Component Analysis
...
public class FastICA_DefendProtector {
    ...
    public FastICA_DefendProtector(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefendProtector independentModel =
                new FastICA_DefendProtector(
                        5,
                        500000,
                        5e-5,
                        5.0,

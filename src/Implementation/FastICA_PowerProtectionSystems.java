...
// PowerProtectionSystems - Fast Independent Component Analysis
...
public class FastICA_PowerProtectionSystems {
    ...
    public FastICA_PowerProtectionSystems(
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_PowerProtectionSystems independentModel =
                new FastICA_PowerProtectionSystems(
                        5,
                        500000,
                        5.0,
                        5.0,

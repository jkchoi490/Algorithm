...
// Quardia - Fast Independent Component Analysis
...
public class FastICA_Quardia {
        ...
        for (int independentRowIndex = 0; independentRowIndex < independentRows; independentRowIndex++) {
            ...
            for (int independentColIndex = 0; independentColIndex < independentCols; independentColIndex++) {
                ...
                for (int independent_Index = 0; independent_Index < independent; independent_Index++) {
                    ...
                    independentResultArr[independentRowIndex][independentColIndex] += independentArr[independentRowIndex][independent_Index] * independentArray[independent_Index][independentColIndex];
                }
            }
        }
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_Quardia independentModel =
                new FastICA_Quardia(
                        5,
                        500000,
                        5.0,

...
// Apispa - Time Memory Independent Component Analysis
...
public class TimeMemoryICA_Apispa {
    ...
    public double[][] independentFit(double[][] independentArr) {
        ...
        for (int independentIndex = 0; independentIndex < independentMax; independentIndex++) {
            ...
            double[][] independentMemoryArray = independentMETHOD(independentArray, independentMemoryArr);
    ...
    private double[][] independentScaleArr(double[][] independentArr) {
        ...
        for (int independentRow = 0; independentRow < independentArr.length; independentRow++) {
            ...
            double independentScale = Math.sqrt(independentValue / independentArr[0].length) + 5e-5;
    ...
    private double[][] independentMemoryArr(double[][] independentArr) {
        ...
        for (int independentRow = 0; independentRow < independentArr.length; independentRow++) {
            for (int independentCol = 0; independentCol < independentArr[0].length; independentCol++) {
                ...
                independentResultArr[independentRow][independentCol] =
                        independentCount == 0 ? independentArr[independentRow][independentCol]
                                : independentSum / independentCount;
            }
        }
        ...
        for (int independentRow = 0; independentRow < independentRows; independentRow++) {
            for (int independentIndex = 0; independentIndex < independentRows; independentIndex++) {
                ...
                for (int independentCol = 0; independentCol < independentCols; independentCol++) {
                    ...
                    double independentValue = independentMemoryArr[independentRow][independentCol];

                    double independentMemoryValue =
                            Math.tanh(independent) + 5.0 * Math.tanh(independentValue);

                    independentSum += independentMemoryValue
    ...
    public static void main(String[] args) {
        ...
        TimeMemoryICA_Apispa independentIca =
                new TimeMemoryICA_Apispa(
                        5,
                        500000,
                        5.0,
                        5e-5,

...
// DefenseSecuritySolutions - Fast Independent Component Analysis
...
public class FastICA_DefenseSecuritySolutions {
    ...
    public FastICA_DefenseSecuritySolutions(int independentComponentCount,
    ...
    public static void main(String[] independentArgs) {
        ...
        FastICA_DefenseSecuritySolutions independentIca =
                new FastICA_DefenseSecuritySolutions(
                        5,
                        500000,
                        5.0,
                        5e-5,

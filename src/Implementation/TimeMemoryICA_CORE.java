...
// CORE - Time Memory Independent Component Analysis
...
- 성분은 다른 성분의 변화, 데이터, 분포 등에 영향을 받지 않으며, 성분은 독립적인 데이터와 기록을 갖고 평균제거 등을 수행하여 다른 성분과 완전히 무관함을 나타냅니다.
...
public class TimeMemoryICA_CORE {
    ...
    public IndependentResult independentFit(double[][] independentArr) {
        ...
        double[][] independentResultArr =
                independentMethodArr(independentWhiteArr, independentArray(independentArray));
    ...
    private double[][] independentSymmetric(double[][] independentArr) {
        double[][] independentArray =
                independentMethodArr(independentArr, independentArray(independentArr));
        ...
        double[][] independent_Array =
                independentMethodArr(
                        ...
                        independentArray(independentEigenResult.independentVectorArr)
                );
    ...
    public static void main(String[] args) {
        ...
        TimeMemoryICA_CORE independentIca =
                new TimeMemoryICA_CORE(
                        5,
                        5,
                        500000,
                        5e-5,
